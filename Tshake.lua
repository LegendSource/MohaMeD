...
if text:match("^تنزيل الكل$") and  is_creatorbasic(msg) and not (is_creator(msg)and  is_owner(msg)and  is_sudo(msg)) and msg.reply_to_message_id_ then
function promote_by_reply(extra, result, success)
...
--------------------------------------------------------------------------
if text:match("^تنزيل الكل$") and  is_creator(msg) and not (is_creatorbasic(msg)and  is_owner(msg)and  is_sudo(msg)) and msg.reply_to_message_id_ then
function promote_by_reply(extra, result, success)
database:srem('tshake:'..bot_id..'mods:'..msg.chat_id_, result.sender_user_id_)
database:srem('tshake:'..bot_id..'vipgp:'..msg.chat_id_, result.sender_user_id_)
database:srem('tshake:'..bot_id..'owners:'..msg.chat_id_, result.sender_user_id_)
...
--------------------------------------------------------------------------
if text:match("^تنزيل الكل$") and  is_sudo(msg) and not (is_creatorbasic(msg) and  is_creator(msg)and is_owner(msg)) and msg.reply_to_message_id_ then
function promote_by_reply(extra, result, success)
database:srem('tshake:'..bot_id..'mods:'..msg.chat_id_, result.sender_user_id_)
database:srem('tshake:'..bot_id..'vipgp:'..msg.chat_id_, result.sender_user_id_)
database:srem('tshake:'..bot_id..'owners:'..msg.chat_id_, result.sender_user_id_)
