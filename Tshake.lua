...
if is_sudo(msg) then
tshake_oop = database:get("tshake:name_sudo"..bot_id..msg.chat_id_)  or 'مطور البوت 👨🏻‍✈️'
elseif is_creatorbasic(msg) then
tshake_oop = database:get("tshake:name_cre"..bot_id..msg.chat_id_) or 'منشئ اساسي 👨🏻‍✈️'
...
tshake_oop = database:get("tshake:name_adm"..bot_id..msg.chat_id_) or ' ادمن الكروب خالي 👩🏿‍🚒'
elseif is_vip(msg) then
tshake_oop = database:get("tshake:name_vipp"..bot_id..msg.chat_id_) or 'عضو مميز  🧟‍♂'
else
tshake_oop = database:get("tshake:name_nk"..bot_id..msg.chat_id_) or 'عضو محد يحترمك 👶🏻😹' 
end
send(msg.chat_id_, msg.id_, 1,"👨🏻‍⚖️┇رتبتك >> "..tshake_oop.."", 1, 'md')
end
