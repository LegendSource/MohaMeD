...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./Matthew.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("Mt", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S Matthew -X kill
screen -S Matthew ./Matthew
done
]])  
file:close() 
...
--------------------------------------------------------------------------------------------------------------
function SourceMatthew(msg,data) -- بداية العمل
if msg then
...
local keyboard = {
{'• تعطيل التواصل ❌','• وضع كليشه start 📑','• تفعيل التواصل ☑️'},
{'• ضع اسم للبوت 🙋🏻','الاحصائيات 📈','• المطورين 👨🏻‍🔧'},
{'• اذاعه توجيه 🚸','• قائمه العام 🚫','• اذاعه توجيه (خاص)📃'},
{'• اذاعه 🔄','• تحديث السورس 🔍','اذاعه خاص 👤'},
{'• تفعيل البوت الخدمي ☑️','جلب نسخه احتياطيه 📂','• تعطيل البوت الخدمي ❌'},
{"• تنظيف الكروبات 🔗",'• حذف كليشه start 📄',"• تنظيف المشتركين 🗑"},
{'الغاء ✖'}
}
...
send(msg.chat_id_, msg.id_,Matthew_Msg) 
return false  
end 
if text then    
...
if text == '• وضع كليشه start 📑' and SudoBot(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,'📥¦ ارسل لي الكليشه الان') 
return false
end
if text == '• حذف كليشه start 📄' and SudoBot(msg) then 
...
if text=="• اذاعه توجيه 🚸" and msg.reply_to_message_id_ == 0  and SudoBot(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"📥¦ ارسل لي التوجيه الان") 
return false
end 
if text=="• اذاعه توجيه (خاص)📃" and msg.reply_to_message_id_ == 0  and SudoBot(msg) then 
...
send(msg.chat_id_, msg.id_,'📌¦ عدد المجموعات الان » { '..#group..' }'..Matthewk..''..Matthew..'\n📌¦  الان عدد المجموعات الحقيقي » { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
usertext = '\n👤¦ العضو » ['..result.title_..'](t.me/'..(username or 'b666P')..')'
...
usertext = '\n👤¦ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'b666P')..')'
status  = '\n📫¦ تم ترقيته مطور في البوت'
...
--------------------------------------------------------------------------------------------------------------
if Matthew_Msg and not Special(msg) then  
local Matthew_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if Matthew_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠¦العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n📛¦["..Matthew_Msg.."] \n") 
else
send(msg.chat_id_,0,"⚠¦العضو : {["..data.first_name_.."](T.ME/b666P)}\n📛¦["..Matthew_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'👤¦ بواسطه ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'b666P')..') \n🔐¦ تـم قفـل الدردشه ')  
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'👤¦ بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'b666P')..') \n🔐¦ تـم قفـل التاك بالكتم ')  
end,nil)   
...
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then
send(msg.chat_id_, msg.id_, '☑️¦ لا تستطبع طردي \n') 
return false 
end
...
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then
send(msg.chat_id_, msg.id_, '☑️¦ لا تستطبع حظري \n') 
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n⚠¦ عذرا لا تستطيع طرد او حظر او كتم او تقييد ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
...
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then
send(msg.chat_id_, msg.id_, '☑️¦ لا تستطبع كتمي \n') 
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n⚠¦ عذرا لا تستطيع طرد او حظر او كتم او تقييد ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
...
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then
send(msg.chat_id_, msg.id_, '☑️¦ لا تستطبع تقييدي \n') 
return false 
end
...
t = "\n⛔¦ قائمة المنع \n━━━━━━━━━━━━━\n"
for k,v in pairs(list) do  
local Matthew_Msg = database:get(bot_id.."Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..''..k..'- '..v..' » {'..Matthew_Msg..'}\n'    
end  
if #list == 0 then  
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n👤¦ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'b666P')..')'..'\n📬¦ تم رفعه '..text1[2]..' هنا')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'ماثيو').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'ماثيو')
local Matthew_Msg = {
'اسمي مينو كول💘؟',
'دا اشرب جاي مفارغلك',
'لابسك لتلح',
...
send(msg.chat_id_, msg.id_,'['..Matthew_Msg[math.random(#Matthew_Msg)]..']') 
return false
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'ماثيو').." غادر" or text == 'غادر' then  
if SudoBot(msg) then 
...
if text == 'نقودي' or text == 'نقودي' then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local NUMPY = text:match("^بيع نقودي (%d+)$") or text:match("^بيع نقودي (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_, '💠¦ ارسل لي عدد النقود الان') 
return false
end
------------------------------------------------------------------------
if text and text:match("^اضف نقود (%d+)$") and msg.reply_to_message_id_ ~= 0 and Constructor(msg) then
...
🎮┇ لعبة المعاني
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
🎁┇ نقودي » لعرض عدد الارباح
💰┇ بيع نقودي + العدد » لستبدال كل مجوهره ب50 رساله
]]
...
Matthew = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(Matthew)
...
--------------------------------------------------------------------------------------------------------------
SourceMatthew(data.message_,data)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
------------------------------------------------------------------------
local Matthewbot = database:get(bot_id.."Add:Filter:Rp2"..text..result.chat_id_)   
if Matthewbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠¦العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n📛¦["..Matthewbot.."] \n") 
