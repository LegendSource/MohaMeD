...
local hash = database:sismember('SNIEBR:'..bot_id..'dev', msg.sender_user_id_) 
...
local hash = database:sismember('SNIEBR:'..bot_id..'creatorbasic:'..msg.chat_id_, msg.sender_user_id_) 
...
local hash = database:sismember('SNIEBR:'..bot_id..'creatorbasic:'..chat,user)
if hash then 
return true 
else 
return false 
...
local hash = database:sismember('SNIEBR:'..bot_id..'creator:'..chat, user) 
if hash then 
return true 
else 
return false 
...
local hash = database:sismember('SNIEBR:'..bot_id..'creator:'..msg.chat_id_, msg.sender_user_id_) 
...
local hash = database:sismember('SNIEBR:'..bot_id..'owners:'..msg.chat_id_,msg.sender_user_id_)    
...
local hash = database:sismember('SNIEBR:'..bot_id..'owners:'..chat, user) 
if hash then 
return true 
else 
return false 
...
function is_mod(msg)
local hash = database:sismember('SNIEBR:'..bot_id..'mods:'..msg.chat_id_,msg.sender_user_id_)    
...
function is_vip(msg)
local hash = database:sismember('SNIEBR:'..bot_id..'vipgp:'..msg.chat_id_,msg.sender_user_id_) 
...
local hash = database:sismember('SNIEBR:'..bot_id..'SET:BAN'..msg.chat_id_,msg.sender_user_id_) 
if hash then    
return true 
else 
return false 
...
var = true  
elseif database:sismember('SNIEBR:'..bot_id..'dev', user_id) then
var = true  
elseif database:sismember('SNIEBR:'..bot_id..'creatorbasic:'..chat_id, user_id) then
var = true
elseif is_creatorbasicc(chat_id, user_id) then
var = true
elseif database:sismember('SNIEBR:'..bot_id..'creator:'..chat_id, user_id) then
var = true  
elseif database:sismember('SNIEBR:'..bot_id..'owners:'..chat_id, user_id) then
var = true  
elseif database:sismember('SNIEBR:'..bot_id..'mods:'..chat_id, user_id) then
var = true  
elseif database:sismember('SNIEBR:'..bot_id..'vipgp:'..chat_id, user_id) then  
var = true  
else  
var = false  
end  
...
if database:sismember("SNEBR:gog"..bot_id, chat_id) then
var = true
else 
var = false
end
...
local var = false
local banned = database:sismember('SNIEBR:'..bot_id..'banned:'..chat_id, user_id)
...
local var = false
local banned = database:sismember('SNIEBR:'..bot_id..'gbanned:', user_id)
if banned then var = true end
return var
end
--         »»                 is_muted                         ««              --
...
local var = false
local banned = database:sismember('SNIEBR:'..bot_id..'muted:'..chat_id, user_id)
if banned then var = true end
return var
end
--         »»                 is_gmuted                         ««              --
...
local var = false 
local banned = database:sismember('SNIEBR:'..bot_id..'gmuted:', user_id)
if banned then var = true end
return var
end
--         »»                 getMessage                         ««              --
...
if text and not database:get('SNIEBR:'..bot_id..'repsudo:mute'..msg.chat_id_) then
...
local tahna = (database:get('SNIEBR:'..bot_id..'nummsg'..msg.chat_id_..msg.sender_user_id_) or 0)
local user_msgs = ((database:get('SNIEBR:'..bot_id..'user:msgs'..msg.chat_id_..':'..msg.sender_user_id_) or 0) + tahna)
local edit = database:get('SNIEBR:'..bot_id..'user:editmsg'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local t = ""
if msg.sender_user_id_ == tonumber(sudo_add) then
t = 'المطور الاساسي'
elseif is_sudo(msg) then
t = database:get("SNIEBR:name_sudo"..bot_id..msg.chat_id_)  or 'مطور البوت '
elseif is_creatorbasic(msg) then
t = database:get("SNIEBR:name_cre"..bot_id..msg.chat_id_) or 'منشئ اساسي '
elseif (database:get("SNIEBR:name_user:"..bot_id..msg.chat_id_..msg.sender_user_id_) and database:get("SNIEBR:all_if:"..database:get("SNIEBR:name_user:"..bot_id..msg.chat_id_..msg.sender_user_id_) ..bot_id..msg.chat_id_)) then 
t = database:get("SNIEBR:name_user:"..bot_id..msg.chat_id_..msg.sender_user_id_)
elseif is_creator(msg) then
t = database:get("SNIEBR:name_cre"..bot_id..msg.chat_id_) or 'منشئ الكروب '
elseif (database:get("SNIEBR:name_user:"..bot_id..msg.chat_id_..msg.sender_user_id_) and database:get("SNIEBR:all_if:"..database:get("SNIEBR:name_user:"..bot_id..msg.chat_id_..msg.sender_user_id_) ..bot_id..msg.chat_id_)) then 
t = database:get("SNIEBR:name_user:"..bot_id..msg.chat_id_..msg.sender_user_id_)
elseif is_owner(msg) then
t = database:get("SNIEBR:name_own"..bot_id..msg.chat_id_) or 'مدير الكروب '
elseif is_mod(msg) then
t = database:get("SNIEBR:name_adm"..bot_id..msg.chat_id_) or 'ادمن الكروب'
elseif is_vip(msg) then
t = database:get("SNIEBR:name_vipp"..bot_id..msg.chat_id_) or ' عضو مميز '
else
t = database:get("SNIEBR:name_nk"..bot_id..msg.chat_id_) or 'عضو فقط ' 
end
...
if text and not database:get('SNIEBR:'..bot_id..'repowner:mute'..msg.chat_id_) then
...
------------------------------------------------------------------------
if database:get('SNIEBR:'..bot_id.."bc:in:pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) and is_sudo(msg) then 
if text and text:match("^الغاء$") or text and text:match("^الغاء ✖$") then   
send(msg.chat_id_, msg.id_, 1, "*📬┇ تم الغاء الاذاعه للمشتركين *\n", 1, "md") 
database:del('SNIEBR:'..bot_id.."bc:in:pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
else 
local gps = database:scard('SNIEBR:'..bot_id.."userss") or 0 
if msg.content_.text_ then
whatbc = 'الرساله'
local list = database:smembers('SNIEBR:'..bot_id..'userss') 
for k,v in pairs(list) do 
...
------------------------------------------------------------------------
if database:get("SNIEBR:set_if_bc_new:"..bot_id..msg.sender_user_id_) and is_sudo(msg) then  
database:del("SNIEBR:set_if_bc_new:"..bot_id..msg.sender_user_id_)
local pro = database:scard('SNIEBR:'..bot_id..'pro:groups') or 0
if text then 
local gpss = database:smembers( 'SNIEBR:'..bot_id.."groups") or 0
for i=1, #gpss do
if not database:sismember('SNIEBR:'..bot_id..'pro:groups', gpss[i]) then
send(gpss[i], 0, 1, text, 1, 'html')		
end					
end
end
if (data.message_.content_.sticker_) then 
gpss = database:smembers( 'SNIEBR:'..bot_id.."groups") or 0
for i=1, #gpss do
if not database:sismember('SNIEBR:'..bot_id..'pro:groups', gpss[i]) then
...
------------------------------------------------------------------------
if text and database:get("ahmad:set:ttt:p"..bot_id..msg.sender_user_id_) then 
send(msg.chat_id_, msg.id_, 1, '📥┇اراسل لان النص الذي يضهر', 1, 'md')
database:set("ahmad:set:ttt:p2"..bot_id..msg.sender_user_id_,true)
database:set("ahmad:set:ttt:ppp:"..bot_id..msg.sender_user_id_,text)
database:del("ahmad:set:ttt:p"..bot_id..msg.sender_user_id_)
end
------------------------------------------------------------------------
if text and database:get("ahmad:set:ttt:p2"..bot_id..msg.sender_user_id_) then 
send(msg.chat_id_, msg.id_, 1, '☑┇تم الحفط', 1, 'md')
ahmad = database:get("ahmad:set:ttt:ppp:"..bot_id..msg.sender_user_id_)
database:sadd("ahmad:all:pppp:tt:"..bot_id,ahmad)
database:set("ahmad:set:text:p"..bot_id..ahmad,text)
database:del("ahmad:set:ttt:p2"..bot_id..msg.sender_user_id_)
end 
------------------------------------------------------------------------
if text and database:get("ahmad:set:ttt:p:Del"..bot_id..msg.sender_user_id_) then 
send(msg.chat_id_, msg.id_, 1, '📥┇اراسل لان التص الذي يضهر', 1, 'md')
database:del("ahmad:set:text:p"..bot_id..text)
database:srem('ahmad:all:pppp:tt:'..bot_id,text)
database:del("ahmad:set:ttt:p:Del"..bot_id..msg.sender_user_id_)
return "ahmad"
end
------------------------------------------------------------------------
...
database:set("SNIEBR:gr:id:text:"..bot_id..msg.chat_id_,text)
end
------------------------------------------------------------------------
if text and text:match("^(.*)$") then
...
if database:get("lock_kansers:SNIEBR"..msg.chat_id_..bot_id) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
local last_ = data.last_name_ or ''
local first_ = data.first_name_ or ''
taha = (first_..''..last_)
Num = (database:get('SNIEBR:'..bot_id..'Num:kansers'..msg.chat_id_) or 25)
...
if database:get('SNIEBR:'..bot_id..'welcome:'..msg.chat_id_) then
text = database:get('SNIEBR:'..bot_id..'welcome:'..msg.chat_id_)
else
text = '👋🏻┇اهلا بك يا ؛ {fr}\n🙋🏼‍♂️┇نورت الكروب ؛ @{us}'
end
...
local taha = database:get('SNIEBR:'..bot_id.."filtr1:add:reply:rd"..text..msg.chat_id_)   
if taha then    
...
local filter = database:smembers('SNIEBR:'..bot_id.."filtersteckr"..msg.chat_id_)
...
local filter = database:smembers('SNIEBR:'..bot_id.."filterphoto"..msg.chat_id_)
for k,v in pairs(filter) do
...
local filter = database:smembers('SNIEBR:'..bot_id.."filteranimation"..msg.chat_id_)
for k,v in pairs(filter) do
...
if database:get('SNIEBR:'..bot_id..'pinnedmsg'..msg.chat_id_) and database:get("lock_pin:SNIEBR"..msg.chat_id_..bot_id) then
local pin_id = database:get('SNIEBR:'..bot_id..'pinnedmsg'..msg.chat_id_)
...
if database:get("lock_link.note:SNIEBR"..msg.chat_id_..bot_id) then
delete_msg(msg.chat_id_,{[0] = msg.id_})
...
database:sadd('SNIEBR:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
end
end
------------------------------------------------------------------------
...
if text and text:match("(.*)(@)(.*)")  then
if database:get("lock_username.note:SNIEBR"..msg.chat_id_..bot_id) then
delete_msg(msg.chat_id_,{[0] = msg.id_})
database:sadd('SNIEBR:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
HTTPS.request("https://api.telegram.org/bot" .. token .. "/restrictChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" .. msg.sender_user_id_ .. "&can_send_messages=false&can_send_media_messages=false&can_send_other_messages=false&can_add_web_page_previews=false") 
database:sadd('SNIEBR:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
...
------------------------------------------------------------------------
if database:get("lock_chat.note:SNIEBR"..msg.chat_id_..bot_id) then
delete_msg(msg.chat_id_,{[0] = msg.id_})
database:sadd('SNIEBR:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
HTTPS.request("https://api.telegram.org/bot" .. token .. "/restrictChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" .. msg.sender_user_id_ .. "&can_send_messages=false&can_send_media_messages=false&can_send_other_messages=false&can_add_web_page_previews=false") 
database:sadd('SNIEBR:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
...
------------------------------------------------------------------------
if text and text:match("(.*)(/)(.*)")  then
if database:get("lock_sarha.note:SNIEBR"..msg.chat_id_..bot_id) then
delete_msg(msg.chat_id_,{[0] = msg.id_})
database:sadd('SNIEBR:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
HTTPS.request("https://api.telegram.org/bot" .. token .. "/restrictChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" .. msg.sender_user_id_ .. "&can_send_messages=false&can_send_media_messages=false&can_send_other_messages=false&can_add_web_page_previews=false") 
database:sadd('SNIEBR:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
...
------------------------------------------------------------------------
if text and text:match("(.*)(#)(.*)")  then
if database:get("lock_tag.note:SNIEBR"..msg.chat_id_..bot_id) then
delete_msg(msg.chat_id_,{[0] = msg.id_})
database:sadd('SNIEBR:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
HTTPS.request("https://api.telegram.org/bot" .. token .. "/restrictChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" .. msg.sender_user_id_ .. "&can_send_messages=false&can_send_media_messages=false&can_send_other_messages=false&can_add_web_page_previews=false") 
database:sadd('SNIEBR:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
...
if database:get("lock_fwd.note:SNIEBR"..msg.chat_id_..bot_id) then
delete_msg(msg.chat_id_,{[0] = msg.id_})
database:sadd('SNIEBR:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
HTTPS.request("https://api.telegram.org/bot" .. token .. "/restrictChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" .. msg.sender_user_id_ .. "&can_send_messages=false&can_send_media_messages=false&can_send_other_messages=false&can_add_web_page_previews=false") 
database:sadd('SNIEBR:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
...
if database:get("lock_stecker.note:SNIEBR"..msg.chat_id_..bot_id) then
delete_msg(msg.chat_id_,{[0] = msg.id_})
database:sadd('SNIEBR:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
HTTPS.request("https://api.telegram.org/bot" .. token .. "/restrictChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" .. msg.sender_user_id_ .. "&can_send_messages=false&can_send_media_messages=false&can_send_other_messages=false&can_add_web_page_previews=false") 
database:sadd('SNIEBR:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
...
if database:get("lock_note.note:SNIEBR"..msg.chat_id_..bot_id) then
delete_msg(msg.chat_id_,{[0] = msg.id_})
database:sadd('SNIEBR:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
HTTPS.request("https://api.telegram.org/bot" .. token .. "/restrictChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" .. msg.sender_user_id_ .. "&can_send_messages=false&can_send_media_messages=false&can_send_other_messages=false&can_add_web_page_previews=false") 
database:sadd('SNIEBR:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
...
if database:get("lock_photo.note:SNIEBR"..msg.chat_id_..bot_id) then
delete_msg(msg.chat_id_,{[0] = msg.id_})
database:sadd('SNIEBR:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
HTTPS.request("https://api.telegram.org/bot" .. token .. "/restrictChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" .. msg.sender_user_id_ .. "&can_send_messages=false&can_send_media_messages=false&can_send_other_messages=false&can_add_web_page_previews=false") 
database:sadd('SNIEBR:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
...
if database:get("lock_audeo.note:SNIEBR"..msg.chat_id_..bot_id) then
delete_msg(msg.chat_id_,{[0] = msg.id_})
database:sadd('SNIEBR:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
HTTPS.request("https://api.telegram.org/bot" .. token .. "/restrictChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" .. msg.sender_user_id_ .. "&can_send_messages=false&can_send_media_messages=false&can_send_other_messages=false&can_add_web_page_previews=false")
database:sadd('SNIEBR:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
...
if database:get("lock_voice.note:SNIEBR"..msg.chat_id_..bot_id) then
delete_msg(msg.chat_id_,{[0] = msg.id_})
database:sadd('SNIEBR:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
HTTPS.request("https://api.telegram.org/bot" .. token .. "/restrictChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" .. msg.sender_user_id_ .. "&can_send_messages=false&can_send_media_messages=false&can_send_other_messages=false&can_add_web_page_previews=false") 
database:sadd('SNIEBR:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
...
if database:get("lock_video.note:SNIEBR"..msg.chat_id_..bot_id) then
delete_msg(msg.chat_id_,{[0] = msg.id_})
database:sadd('SNIEBR:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
HTTPS.request("https://api.telegram.org/bot" .. token .. "/restrictChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" .. msg.sender_user_id_ .. "&can_send_messages=false&can_send_media_messages=false&can_send_other_messages=false&can_add_web_page_previews=false")
database:sadd('SNIEBR:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
...
if database:get("lock_gif.note:SNIEBR"..msg.chat_id_..bot_id) then
delete_msg(msg.chat_id_,{[0] = msg.id_})
database:sadd('SNIEBR:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
HTTPS.request("https://api.telegram.org/bot" .. token .. "/restrictChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" .. msg.sender_user_id_ .. "&can_send_messages=false&can_send_media_messages=false&can_send_other_messages=false&can_add_web_page_previews=false") 
database:sadd('SNIEBR:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
...
if database:get("lock_contect.note:SNIEBR"..msg.chat_id_..bot_id) then
delete_msg(msg.chat_id_,{[0] = msg.id_})
database:sadd('SNIEBR:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
HTTPS.request("https://api.telegram.org/bot" .. token .. "/restrictChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" .. msg.sender_user_id_ .. "&can_send_messages=false&can_send_media_messages=false&can_send_other_messages=false&can_add_web_page_previews=false")
database:sadd('SNIEBR:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
...
if database:get("lock_ar.note:SNIEBR"..msg.chat_id_..bot_id) then
delete_msg(msg.chat_id_,{[0] = msg.id_})
database:sadd('SNIEBR:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
HTTPS.request("https://api.telegram.org/bot" .. token .. "/restrictChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" .. msg.sender_user_id_ .. "&can_send_messages=false&can_send_media_messages=false&can_send_other_messages=false&can_add_web_page_previews=false") 
database:sadd('SNIEBR:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
...
if database:get("lock_files.note:SNIEBR"..msg.chat_id_..bot_id) then
delete_msg(msg.chat_id_,{[0] = msg.id_})
database:sadd('SNIEBR:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
HTTPS.request("https://api.telegram.org/bot" .. token .. "/restrictChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" .. msg.sender_user_id_ .. "&can_send_messages=false&can_send_media_messages=false&can_send_other_messages=false&can_add_web_page_previews=false") 
database:sadd('SNIEBR:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
...
if database:get("lock_en.note:SNIEBR"..msg.chat_id_..bot_id) then
delete_msg(msg.chat_id_,{[0] = msg.id_})
database:sadd('SNIEBR:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
HTTPS.request("https://api.telegram.org/bot" .. token .. "/restrictChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" .. msg.sender_user_id_ .. "&can_send_messages=false&can_send_media_messages=false&can_send_other_messages=false&can_add_web_page_previews=false") 
database:sadd('SNIEBR:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
...
if database:get("lock_mark.note:SNIEBR"..msg.chat_id_..bot_id) then
delete_msg(msg.chat_id_,{[0] = msg.id_})
HTTPS.request("https://api.telegram.org/bot" .. token .. "/restrictChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" .. msg.sender_user_id_ .. "&can_send_messages=false&can_send_media_messages=false&can_send_other_messages=false&can_add_web_page_previews=false") 
database:sadd('SNIEBR:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
end
...
------------------------------------------------------------------------
if text and text:match("(.*)") then
if database:get("lock_word:SNIEBR"..msg.chat_id_..bot_id) then 
local SNIEBR_wr = (database:get("SNIEBR:not:word:"..bot_id..msg.chat_id_) or 100)
...
if database:get("lock_link:SNIEBR"..msg.chat_id_..bot_id) then
delete_msg(msg.chat_id_,{[0] = msg.id_})
return false
end
end
...
local text = msg.content_.caption_
if text and text:match("(.*)(@)(.*)")  then
if database:get("lock_username:SNIEBR"..msg.chat_id_..bot_id) then
delete_msg(msg.chat_id_,{[0] = msg.id_})
return false
end
end
...
------------------------------------------------------------------------
if database:get("lock_chat:SNIEBR"..msg.chat_id_..bot_id) then
delete_msg(msg.chat_id_,{[0] = msg.id_})
return false
end
------------------------------------------------------------------------
if text and text:match("(.*)(/)(.*)")  then
if database:get("lock_sarha:SNIEBR"..msg.chat_id_..bot_id) then
delete_msg(msg.chat_id_,{[0] = msg.id_})
return false
end
end
------------------------------------------------------------------------
if text and text:match("(.*)(#)(.*)")  then
if database:get("lock_tag:SNIEBR"..msg.chat_id_..bot_id) then
delete_msg(msg.chat_id_,{[0] = msg.id_})
return false
end
end
...
if database:get("lock_reple:SNIEBR"..msg.chat_id_..bot_id) then
delete_msg(msg.chat_id_,{[0] = msg.id_})
return false
end
end
------------------------------------------------------------------------
if  msg.content_.ID == "MessageChatJoinByLink" then
if database:get("lock_join:SNIEBR"..msg.chat_id_..bot_id) then
...
if database:get("lock_bot:SNIEBR"..msg.chat_id_..bot_id) and not bot_id then
changeChatMemberStatus(msg.chat_id_, msg.content_.members_[0].id_, "Kicked")
end
if database:get("lock_botAndBan:SNIEBR"..msg.chat_id_..bot_id) then
...
if msg.forward_info_ then
if msg.forward_info_.ID == "MessageForwardedFromUser" or msg.forward_info_.ID == "MessageForwardedPost" then
if database:get("lock_fwd:SNIEBR"..msg.chat_id_..bot_id) then
delete_msg(msg.chat_id_,{[0] = msg.id_})
return false
end
end
...
if database:get("lock_stecker:SNIEBR"..msg.chat_id_..bot_id) then
delete_msg(msg.chat_id_,{[0] = msg.id_})
return false
end
end
...
if database:get("lock_new:SNIEBR"..msg.chat_id_..bot_id) then
delete_msg(msg.chat_id_,{[0] = msg.id_})
return false
end
end
------------------------------------------------------------------------
if msg.content_.ID == "MessageUnsupported" then
if database:get("lock_note:SNIEBR"..msg.chat_id_..bot_id) then
delete_msg(msg.chat_id_,{[0] = msg.id_})
return false
end
end
------------------------------------------------------------------------
if msg.content_.ID == "MessagePhoto" then
if database:get("lock_photo:SNIEBR"..msg.chat_id_..bot_id) then
delete_msg(msg.chat_id_,{[0] = msg.id_})
return false
end
end
------------------------------------------------------------------------
if msg.content_.ID == "MessageAudio" then
if database:get("lock_audeo:SNIEBR"..msg.chat_id_..bot_id) then
delete_msg(msg.chat_id_,{[0] = msg.id_})
return false
end
end
------------------------------------------------------------------------
if msg.content_.ID == "MessageVoice" then
if database:get("lock_voice:SNIEBR"..msg.chat_id_..bot_id) then
delete_msg(msg.chat_id_,{[0] = msg.id_})
return false
end
end
------------------------------------------------------------------------
if msg.content_.ID == "MessageVideo" then
if database:get("lock_video:SNIEBR"..msg.chat_id_..bot_id) then
delete_msg(msg.chat_id_,{[0] = msg.id_})
return false
end
end
------------------------------------------------------------------------
if msg.content_.ID == "MessageAnimation" then
if database:get("lock_gif:SNIEBR"..msg.chat_id_..bot_id) then
delete_msg(msg.chat_id_,{[0] = msg.id_})
return false
end
end
------------------------------------------------------------------------
if msg.content_.ID == "MessageContact" then
if database:get("lock_contact:SNIEBR"..msg.chat_id_..bot_id) then
delete_msg(msg.chat_id_,{[0] = msg.id_})
return false
end
end
------------------------------------------------------------------------
if text and text:match("[\216-\219][\128-\191]") then
if database:get("lock_ar:SNIEBR"..msg.chat_id_..bot_id) then
delete_msg(msg.chat_id_,{[0] = msg.id_})
return false
end
end
------------------------------------------------------------------------
if msg.content_.ID == "MessageDocument" then
if database:get("lock_files:SNIEBR"..msg.chat_id_..bot_id) then
delete_msg(msg.chat_id_,{[0] = msg.id_})
return false
end
end
------------------------------------------------------------------------
if text and text:match("[ASDFGHJKLQWERTYUIOPZXCVBNMasdfghjklqwertyuiopzxcvbnm]") then
if database:get("lock_en:SNIEBR"..msg.chat_id_..bot_id) then
delete_msg(msg.chat_id_,{[0] = msg.id_})
return false
end
end
...
if msg.content_.entities_[0] then
if msg.content_.entities_[0] and msg.content_.entities_[0].ID == "MessageEntityUrl" or msg.content_.entities_[0].ID == "MessageEntityTextUrl" then
if database:get("lock_mark:SNIEBR"..msg.chat_id_..bot_id) then
delete_msg(msg.chat_id_,{[0] = msg.id_})
return false
end
end
...
if msg.content_.ID == "MessageChatAddMembers" then
database:incr('SNIEBR:'..bot_id..'user:add'..msg.chat_id_..':'..msg.sender_user_id_)
if not is_vip(msg) then
if database:get("lock_join:SNIEBR"..msg.chat_id_..bot_id) then
changeChatMemberStatus(msg.chat_id_, msg.content_.members_[0].id_, "Kicked")
return false
...
------------------------------------------------------------------------
if database:get("lock_lllll:SNIEBR"..msg.chat_id_..bot_id) then
...
database:set("lock_media:SNIEBR"..msg.chat_id_..bot_id,"ok")
database:set("lock_audeo:SNIEBR"..msg.chat_id_..bot_id,"ok")
database:set("lock_video:SNIEBR"..msg.chat_id_..bot_id,"ok")
database:set("lock_photo:SNIEBR"..msg.chat_id_..bot_id,"ok")
database:set("lock_stecker:SNIEBR"..msg.chat_id_..bot_id,"ok")
database:set("lock_voice:SNIEBR"..msg.chat_id_..bot_id,"ok")
database:set("lock_gif:SNIEBR"..msg.chat_id_..bot_id,"ok")
database:set("lock_note:SNIEBR"..msg.chat_id_..bot_id,"ok")
database:set("lock_word:SNIEBR"..msg.chat_id_..bot_id,"ok")
database:set("lock_mark:SNIEBR"..msg.chat_id_..bot_id,"ok")
database:set("lock_link:SNIEBR"..msg.chat_id_..bot_id,"ok")
database:set("lock_new:SNIEBR"..msg.chat_id_..bot_id,"ok")
database:set('SNIEBR:'..bot_id..'get:photo'..msg.chat_id_,true)
...
database:sadd('SNIEBR:'..bot_id..'muted:'..msg.chat_id_, msg.sender_user_id_)
end
end
...
------------------------------------------------------------------------
if msg.content_.photo_ then
local photo = database:get('SNIEBR:'..bot_id..'setphoto'..msg.chat_id_..':'..msg.sender_user_id_)
if photo then
local idPh = nil
if msg.content_.photo_.sizes_[0] then
...
database:del('SNIEBR:'..bot_id..'setphoto'..msg.chat_id_..':'..msg.sender_user_id_)
return false
end 
end
------------------------------------------------------------------------
...
if not database:sismember( 'SNIEBR:'..bot_id.."groups",msg.chat_id_) then
database:sadd( 'SNIEBR:'..bot_id.."groups",msg.chat_id_)
end
elseif id:match('^(%d+)') then
database:sadd('SNIEBR:'..bot_id.."userss",msg.chat_id_)
else
if not database:sismember( 'SNIEBR:'..bot_id.."groups",msg.chat_id_) then
database:sadd( 'SNIEBR:'..bot_id.."groups",msg.chat_id_)
end
...
database:incr('SNIEBR:'..bot_id..'user:msgs'..msg.chat_id_..':'..msg.sender_user_id_)
------------------------------------------------------------------------
if database:get('SNIEBR:'..bot_id..'viewget'..msg.sender_user_id_) then
if not msg.forward_info_ then
send(msg.chat_id_, msg.id_, 1, '❕┇قم بارسال المنشور من القناة', 1, 'md')
database:del('SNIEBR:'..bot_id..'viewget'..msg.sender_user_id_)
else
...
info = '👤┇بواسطه ← ['..result.first_name_..'](t.me/'..(result.username_ or 'SNIEBRTEAM')..')\n'
local ahmad2 = database:get("add"..bot_id)
if ahmad2 then
...
openChat(msg.chat_id_,SNEBR_info2) 
--
end
else
...
local ahmadn = database:get("ts_a"..bot_id) or 1000
...
openChat(msg.chat_id_,SNEBR_info)
database:sadd("SNEBR:gog"..bot_id, msg.chat_id_)
function SNEBR_info2(k1,k2)
function dl_cb222(t1,t2)
...
database:set('SNIEBR:'..bot_id.."group:link"..msg.chat_id_,(t2.invite_link_ or "Error")) 
send(tostring((database:get("SNIEBR"..bot_id..":sudo:gr") or sudo_add)), 0, 1, "🔘┇قام بتفعيل مجموعه \n🎫┇ايدي المنشئ ~⪼ ("..msg.sender_user_id_..")\n☑️┇معرف المنشئ ~⪼ @"..(result.username_ or "لا يوجد").."\n🌐┇معلومات المجموعه \n\n🎫┇ايدي المجموعه ~⪼ ("..msg.chat_id_..")\nⓂ️┇اسم المجموعه ~⪼ ("..k2.title_..")\n📎┇رابط المجموعه ~⪼ ["..(t2.invite_link_ or "Error").."]" , 1, 'html')
end
tdcli_function ({
ID = "GetChannelFull",
channel_id_ = getChatId(msg.chat_id_).ID
...
database:sadd('SNIEBR:'..bot_id..'owners:'..msg.chat_id_,msg.sender_user_id_)
end
database:set( 'SNIEBR:'..bot_id.."enable:"..msg.chat_id_,true)
if data.result.status == 'creator' then
database:sadd('SNIEBR:'..bot_id..'creator:'..msg.chat_id_, msg.sender_user_id_)
database:sadd('SNIEBR:'..bot_id..'creatorbasic:'..msg.chat_id_, msg.sender_user_id_)
end
end
else
...
database:del('SNIEBR:'..bot_id..'gbanned:')
send(msg.chat_id_, msg.id_, 1, text, 1, 'md')
return false
end
if text == ("مسح المكتومين عام") then
text = '☑┇ تم مسح المكتومين عام'
database:del('SNIEBR:'..bot_id..'gmuted:')
send(msg.chat_id_, msg.id_, 1, text, 1, 'md')
return false
end
------------------------------------------------------------------------
...
for k,v in pairs(list) do
local user_info = database:hgetall('SNIEBR:'..bot_id..'user:'..v)
...
local gps = database:scard('SNIEBR:'..bot_id.."groups")  
...
database:set("ahmad:set:ttt:p"..bot_id..msg.sender_user_id_,true)
return "ahmad"
end 
if text and (text == "التفاعلات" or text == "قائمه التفاعلات" and end032 ) then 
ahmad = database:smembers('ahmad:all:pppp:tt:'..bot_id) or 0
...
for i=1, #ahmad do
local tttee = database:get("ahmad:set:text:p"..bot_id..ahmad[i])
...
ahmad = database:smembers('ahmad:all:pppp:tt:'..bot_id) or 0
for i=1, #ahmad do
database:del("ahmad:set:text:p"..bot_id..ahmad[i])
end
database:del('ahmad:all:pppp:tt:'..bot_id)
end
if text and text == "حذف تفاعل" then 
send(msg.chat_id_, msg.id_, 1, '📥┇ارسال لان عدد الرسال الذي يجب ان يكون اكثر منه', 1, 'md')
database:set("ahmad:set:ttt:p:Del"..bot_id..msg.sender_user_id_,true)
return "ahmad"
end 
...
local gps = database:scard('SNIEBR:'..bot_id.."userss")  
...
local pv = database:smembers('SNIEBR:'..bot_id.."userss")
local sendok = 0
for i = 1, #pv do
...
database:srem('SNIEBR:'..bot_id.."userss",pv[i])
sendok = sendok + 1
end
if #pv == i then 
if sendok == 0 then
...
local group = database:smembers('SNIEBR:'..bot_id..'groups') 
local w = 0
local q = 0
for i = 1, #group do
...
database:srem("SNEBR:gog"..bot_id,group[i]) 
database:srem('SNIEBR:'..bot_id..'pro:groups',group[i]) 
database:srem( 'SNIEBR:'..bot_id.."groups",group[i]) 
...
local gps = database:smembers('SNIEBR:'..bot_id.."groups") or 0
local gps2 = database:smembers("SNEBR:gog"..bot_id) or 0
for i=1,#gps do
database:sadd("SNEBR:gog"..bot_id, gps[i])
database:set('SNIEBR:'..bot_id.."enable:"..gps[i],true)
database:set( 'SNIEBR:'..bot_id.."charge:"..gps[i],true)
end
...
local gps2 = database:smembers("SNEBR:gog"..bot_id) or 0
for i=1,#gps do
database:del("SNEBR:gog"..bot_id)
database:del('SNIEBR:'..bot_id.."enable:"..gps[i])
database:del( 'SNIEBR:'..bot_id.."charge:"..gps[i])
end
...
database:del("SNEBR:gog"..bot_id)
database:del('SNIEBR:'..bot_id.."groups")
end
------------------------------------------------------------------------
...
for i=1, #gpss do
local link = database:get('SNIEBR:'..bot_id.."group:link"..gpss[i])
...
local gpss = database:smembers("SNEBR:good"..bot_id..os.date("%d")) or 0
...
if database:sismember('SNIEBR:'..bot_id..'pro:groups',msg.chat_id_) then
...
database:sadd('SNIEBR:'..bot_id..'pro:groups',msg.chat_id_)
end
end
if (text and text == 'تعطيل وضع المدفوع') then
if not database:sismember('SNIEBR:'..bot_id..'pro:groups',msg.chat_id_) then
...
if (not database:get('SNIEBR:'..bot_id..'bc:groups') or tonumber(sudo_add) == tonumber(msg.sender_user_id_)) then
send(msg.chat_id_, msg.id_, 1, '☑┇ ارسال الان نص او الميديا : (صوره - فديو - متحركه - ملف)', 1, 'md')
database:set("SNIEBR:set_if_bc_new:"..bot_id..msg.sender_user_id_,"ok")
return "SNIEBR"
else
...
if (not database:get('SNIEBR:'..bot_id..'bc:groups') or tonumber(sudo_add) == tonumber(msg.sender_user_id_)) then
database:setex('SNIEBR:'..bot_id.."bc:in:pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
database:set('SNIEBR:'..bot_id.."group:link"..msg.chat_id_,(t2.invite_link_ or "Error")) 
send(tostring((database:get("SNIEBR"..bot_id..":sudo:gr") or sudo_add)), 0, 1, "🔘┇قام تعطيل مجموعه \n📌┇ايدي مطور ~⪼ ("..msg.sender_user_id_..")\n📜┇معرف المطور ~⪼ @"..(result.username_ or "لا يوجد").."\n🌐┇معلومات المجموعه \n\n🎫┇ايدي المجموعه ~⪼ ("..msg.chat_id_..")\nⓂ️┇اسم المجموعه ~⪼ ("..k2.title_..")\n📎┇رابط المجموعه ~⪼ ["..(t2.invite_link_ or "Error").."]" , 1, 'html')
end
tdcli_function ({
ID = "GetChannelFull",
channel_id_ = getChatId(msg.chat_id_).ID
...
local lave = database:get('SNIEBR:'..bot_id..'leave:groups')
print(lave)
if not database:get('SNIEBR:'..bot_id..'leave:groups') then
...
database:del('SNIEBR:'..bot_id..'creatorbasic:'..msg.chat_id_)
send(msg.chat_id_, msg.id_, 1, text, 1, 'md')
return false
end
...
return false end
function promote_by_reply(extra, result, success)
database:sadd('SNIEBR:'..bot_id..'creatorbasic:'..msg.chat_id_, result.sender_user_id_)
...
database:sadd('SNIEBR:'..bot_id..'creatorbasic:'..msg.chat_id_, result.id_)
...
database:sadd('SNIEBR:'..bot_id..'creatorbasic:'..msg.chat_id_, apmd[2])
...
return false end
function promote_by_reply(extra, result, success)
database:srem('SNIEBR:'..bot_id..'creatorbasic:'..msg.chat_id_, result.sender_user_id_)
...
function promote_by_username(extra, result, success)
if result.id_ then
database:srem('SNIEBR:'..bot_id..'creatorbasic:'..msg.chat_id_, result.id_)
...
database:srem('SNIEBR:'..bot_id..'creatorbasic:'..msg.chat_id_, apmd[2])
tsX000(apmd[2],msg,"تم تنزيلة منشئ اساسي من البوت")
return false
end
------------------------------------------------------------------------
if (text == ("عدد الكروبات") or text ==("الاحصائيات")) then
local gps = database:scard('SNIEBR:'..bot_id.."groups") or 0
local user = database:scard('SNIEBR:'..bot_id.."userss") or 0
local gps2 = database:scard("SNEBR:gog"..bot_id) or 0
local gps9 = database:scard("SNEBR:good"..bot_id..os.date("%d")) or 0
local gps3 = database:scard('SNIEBR:'..bot_id..'pro:groups') or 0
...
local time = a[2] * day
database:setex( 'SNIEBR:'..bot_id.."charge:"..msg.chat_id_,time,true)
database:set( 'SNIEBR:'..bot_id.."enable:"..msg.chat_id_,true)
...
local ex = database:ttl( 'SNIEBR:'..bot_id.."charge:"..txt[2])
if ex == -1 then
...
database:del("SNEBR:gog"..bot_id,txt[2])
...
database:setex( 'SNIEBR:'..bot_id.."charge:"..txt[2],timeplan1,true)
...
database:set( 'SNIEBR:'..bot_id.."enable:"..txt[2],true)
end
getUser(msg.sender_user_id_, ahmad333)
end
------------------------------------------------------------------------
...
database:setex( 'SNIEBR:'..bot_id.."charge:"..txt[2],timeplan2,true)
...
function ahmad333(extra,result,success)
ahmad_info = '@'..(result.username_ or 'لا يوجد')..''
database:set( 'SNIEBR:'..bot_id.."charge:"..txt[2],true)
...
local list = database:smembers('SNIEBR:'..bot_id..'creatorbasic:'..msg.chat_id_)
if #list == 0 then
...
database:sadd('SNIEBR:'..bot_id..'creator:'..msg.chat_id_, result.id_)
...
send(msg.chat_id_, msg.id_, 1,'\n• اهلا بك عزيزي 🔱 •\n• لايمكنك استخدام البوت ✅ •\n• عليك الاشتراك في القناة 🔽 •\n• @SNIEBR ⚜️\n', 1, 'html')   
return false end
database:sadd('SNIEBR:'..bot_id..'creator:'..msg.chat_id_, apow[2])
...
database:del('SNIEBR:'..bot_id..'creator:'..msg.chat_id_)
...
local tsX_o = database:get("lock_edit:SNIEBR"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"🔐┇ بالفعل تم قفل التعديل ")
else
tsX000("lock",msg,"🔐┇تم قفل التعديل ")
database:set("lock_edit:SNIEBR"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "قفل التعديل بالطرد") then
local tsX_o = database:get("lock_edit:SNIEBR:kick"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"🔐┇ بالفعل تم قفل التعديل بالطرد")
else
tsX000("lock",msg,"🔐┇تم قفل التعديل بالطرد")
database:set("lock_edit:SNIEBR:kick"..msg.chat_id_..bot_id,"ok")
end
end
...
database:del("lock_edit:SNIEBR"..msg.chat_id_..bot_id,"ok")
end
end
...
database:del("lock_edit:SNIEBR:kick"..msg.chat_id_..bot_id,"ok")
end
end
if text == 'مسح المدراء' then
database:del('SNIEBR:'..bot_id..'owners:'..msg.chat_id_)
...
database:sadd('SNIEBR:'..bot_id..'owners:'..msg.chat_id_, result.id_)
...
database:sadd('SNIEBR:'..bot_id..'owners:'..msg.chat_id_, apow[2])
...
database:set("SNIEBR:mute:deleta:msg:"..bot_id..msg.chat_id_,"SNIEBRE")
send(msg.chat_id_, msg.id_, 1, "🔌┇تم تعطيل خاصيه الابلاغ", 1, 'html')
end
if (text and text == "تفعيل الابلاغ") then 
database:del("SNIEBR:mute:deleta:msg:"..bot_id..msg.chat_id_)
...
database:del('SNIEBR:'..bot_id..'nummsg'..msg.chat_id_..result.sender_user_id_)
local user_msgs = database:get('SNIEBR:'..bot_id..'user:msgs'..msg.chat_id_..':'..result.sender_user_id_)
...
database:set('SNIEBR:'..bot_id.."SNIEBR:lock:set"..msg.chat_id_,"SNIEBR")
...
database:del('SNIEBR:'..bot_id.."SNIEBR:lock:set"..msg.chat_id_)
...
database:set("SNIEBR:lock:ban_and_kick"..bot_id..msg.chat_id_,"SNIEBR")
send(msg.chat_id_, msg.id_, 1, '🔌┇تم تعطيل (طرد - حضر) الاعضاء', 1, 'md')
end
if (text and (text == "تفعيل الطرد" or text == "تفعيل الحظر")) then
database:del("SNIEBR:lock:ban_and_kick"..bot_id..msg.chat_id_)
...
database:set("SNIEBR:name_own"..bot_id..msg.chat_id_,ac[1]) 
send(msg.chat_id_, msg.id_, 1, "تم تغير الرد الى --> "..ac[1], 1, 'md')
end
------------------------------------
if text and text:match("^تغير رد الادمن (.*)$") then
ac = {string.match(text, "^تغير رد الادمن (.*)$")}
database:set("SNIEBR:name_adm"..bot_id..msg.chat_id_,ac[1])
send(msg.chat_id_, msg.id_, 1, "تم تغير الرد الى --> "..ac[1], 1, 'md')
end
--------------------------------
if text and text:match("^تغير رد العضو المميز (.*)$") then
ac = {string.match(text, "^تغير رد العضو المميز (.*)$")}
database:set("SNIEBR:name_vipp"..bot_id..msg.chat_id_,ac[1])
send(msg.chat_id_, msg.id_, 1, "تم تغير الرد الى --> "..ac[1], 1, 'md')
end
-------------------------------
if text and text:match("^تغير رد العضو فقط (.*)$") then
ac = {string.match(text, "^تغير رد العضو فقط (.*)$")}
database:set("SNIEBR:name_nk"..bot_id..msg.chat_id_,ac[1])
send(msg.chat_id_, msg.id_, 1, "تم تغير الرد الى --> "..ac[1], 1, 'md')
end
--------------------------------
if (text and text == "اضف صلاحيه") then 
send(msg.chat_id_, msg.id_, 1, '☑┇ارسال الان اسم الصلاحيه', 1, 'md')
database:set("SNIEBR:new:if:"..bot_id..msg.chat_id_..msg.sender_user_id_,"ok1")
return "SNIEBR"
end
if text and database:get("SNIEBR:new:if:"..bot_id..msg.chat_id_..msg.sender_user_id_) then 
database:del("SNIEBR:new:if:"..bot_id..msg.chat_id_..msg.sender_user_id_)
send(msg.chat_id_, msg.id_, 1, '📥┇الان ارسل نوع الصلاحيه المطلوبه \n🔰┇{ `مدير` ،`ادمن` ،`عضو مميز` ,`لا شيئ `}', 1, 'md')
database:set("SNIEBR:new:if:text:"..bot_id..msg.chat_id_..msg.sender_user_id_,text)
database:set("SNIEBR:new:if2:"..bot_id..msg.chat_id_..msg.sender_user_id_,"ok1")
return "SNIEBR"
end
if (text and database:get("SNIEBR:new:if2:"..bot_id..msg.chat_id_..msg.sender_user_id_)) then 
if (text == "ادمن" or text == "مدير" or text == "عضو مميز" or text == "لا شيئ") then 
database:del("SNIEBR:new:if2:"..bot_id..msg.chat_id_..msg.sender_user_id_)
tsha_text = database:get("SNIEBR:new:if:text:"..bot_id..msg.chat_id_..msg.sender_user_id_)
send(msg.chat_id_, msg.id_, 1, '☑️┇تم حفض الصلاحيه بنجاح \n⚠️┇الاوامر { رفع/تنزيل '..tsha_text..' }', 1, 'md')
database:set("SNIEBR:all_if:"..tsha_text..bot_id..msg.chat_id_,text)
database:del("SNIEBR:new:if:text:"..bot_id..msg.chat_id_..msg.sender_user_id_)
else 
send(msg.chat_id_, msg.id_, 1, '??┇الان ارسل نوع الصلاحيه المطلوبه \n🔰┇{ `مدير` ،`ادمن` ،`عضو مميز` ,`لا شيئ `}', 1, 'md')
end
end
...
database:set('SNIEBR:'..bot_id..'gamepoint' .. msg.chat_id_, kara[2] or 50)
...
database:sadd('SNIEBR:'..bot_id..'SET:BAN'..msg.chat_id_, result.sender_user_id_)
end
...
database:sadd('SNIEBR:'..bot_id..'SET:BAN'..msg.chat_id_, result.id_)
...
database:srem('SNIEBR:'..bot_id..'SET:BAN'..msg.chat_id_, result.sender_user_id_)
end
getMessage(msg.chat_id_, msg.reply_to_message_id_,by_reply)
end
...
function promote_by_username(extra, result, success)
if result.id_ then
database:srem('SNIEBR:'..bot_id..'SET:BAN'..msg.chat_id_, result.id_)
...
database:del('SNIEBR:'..bot_id..'SET:BAN'..msg.chat_id_)
...
database:set("tsahke:new:msg:"..msg.chat_id_..msg.sender_user_id_..bot_id,SNIEBR_edis[1])
...
database:set("SNIEBR:edit:text:su:new:"..bot_id..msg.chat_id_..database:get("tsahke:new:msg:"..msg.chat_id_..msg.sender_user_id_..bot_id),text)
database:set("SNIEBR:edit:text:su:new2:"..bot_id..msg.chat_id_..text,database:get("tsahke:new:msg:"..msg.chat_id_..msg.sender_user_id_..bot_id))
...
local klma = database:get("SNIEBR:edit:text:su:new:"..bot_id..msg.chat_id_..t[1])
if klma ~= nil then
database:del("SNIEBR:edit:text:su:new2:"..bot_id..msg.chat_id_..klma)
database:del("SNIEBR:edit:text:su:new:"..bot_id..msg.chat_id_..t[1])
...
local list = database:smembers('SNIEBR:'..bot_id..'SNIEBRnwe:'..msg.chat_id_)
if #list == 0 then
...
for k,v in pairs(list) do
var = database:get("SNIEBR:edit:text:su:newamr:"..bot_id..msg.chat_id_..v)
if var then
t = t..''..k..'- '..v..' » ('..var..')\n'
else
t = t..''..k..'- '..v..'\n'
...
local list = database:smembers('SNIEBR:'..bot_id..'SNIEBRnwe:'..msg.chat_id_)
for k,v in pairs(list) do
local klma = database:get("SNIEBR:edit:text:su:newamr:"..bot_id..msg.chat_id_..v)
if klma ~= nil then
database:del("SNIEBR:edit:text:su:newamr2:"..bot_id..msg.chat_id_..klma)
database:del("SNIEBR:edit:text:su:newamr:"..bot_id..msg.chat_id_..v)
end
end
database:del('SNIEBR:'..bot_id..'SNIEBRnwe:'..msg.chat_id_)
...
database:set('SNIEBR:'..bot_id..'pinnedmsg'..msg.chat_id_,msg.reply_to_message_id_)
...
send(msg.chat_id_, msg.id_, 1,'\n• اهلا بك عزيزي 🔱 •\n• لايمكنك استخدام البوت ✅ •\n• عليك الاشتراك في القناة 🔽 •\n• @SNIEBR ⚜️\n', 1, 'html')   
return false end
if not is_creator(msg) and database:get('SNIEBR:'..bot_id.."SNIEBR:lock:set"..msg.chat_id_) then 
...
database:sadd('SNIEBR:'..bot_id..'mods:'..msg.chat_id_, result.id_)
...
send(msg.chat_id_, msg.id_, 1,'\n• اهلا بك عزيزي 🔱 •\n• لايمكنك استخدام البوت ✅ •\n• عليك الاشتراك في القناة 🔽 •\n• @SNIEBR ⚜️\n', 1, 'html')   
return false end
database:sadd('SNIEBR:'..bot_id..'mods:'..msg.chat_id_, apmd[2])
...
database:del('SNIEBR:'..bot_id..'mods:'..msg.chat_id_)
...
database:set("tsahke:set:id:"..bot_id..msg.chat_id_..msg.sender_user_id_,'SNIEBR')
return "SNIEBR"
end

if text and text == "مسح الايدي" then
send(msg.chat_id_, msg.id_, 1,  '✖┇ تم المسح بنجاح', 1, 'md')
database:del("SNIEBR:gr:id:text:"..bot_id..msg.chat_id_)
end
...
database:set('SNIEBR:'..bot_id..'flood:max:'..msg.chat_id_,floodmax[2])
...
database:set('SNIEBR:'..bot_id..'flood:time:'..msg.chat_id_,floodt[2])
...
i = i + 1
local user_info = database:hgetall('SNIEBR:'..bot_id..'user:'..v.user_id_)
if user_info and user_info.username then
local username = user_info.username
...
if not database:get('SNIEBR:'..bot_id..'kickme:mute'..msg.chat_id_) then
send(msg.chat_id_, msg.id_, 1, '✔️┇ امر اطردني بالفعل تم تفعيلة ', 1, 'md')
else
send(msg.chat_id_, msg.id_, 1, '✔️┇ امر اطردني تم تفعيلة ', 1, 'md')
database:del('SNIEBR:'..bot_id..'kickme:mute'..msg.chat_id_)
end
end
if (text and text == 'تعطيل اطردني') then
if database:get('SNIEBR:'..bot_id..'kickme:mute'..msg.chat_id_) then
send(msg.chat_id_, msg.id_, 1, '🔌┇ تم تعطيل امر اطردني بالفعل ', 1, 'md')
else
send(msg.chat_id_, msg.id_, 1, '🔌┇ تم تعطيل امر اطردني ', 1, 'md')
database:set('SNIEBR:'..bot_id..'kickme:mute'..msg.chat_id_,true)
end
end
if text and text:match("^رفع (.*)$")  and msg.reply_to_message_id_ then
a = {string.match(text, "^رفع (.*)$")}
ts_text = database:get("SNIEBR:all_if:"..a[1]..bot_id..msg.chat_id_)
if ts_text then 
function promote_by_reply(extra, result, success)
if ts_text == "ادمن" then 
database:sadd('SNIEBR:'..bot_id..'mods:'..msg.chat_id_, result.sender_user_id_)
elseif ts_text == "عضو مميز" then 
database:sadd('SNIEBR:'..bot_id..'vipgp:'..msg.chat_id_, result.sender_user_id_)
elseif ts_text == "مدير" then 
database:sadd('SNIEBR:'..bot_id..'owners:'..msg.chat_id_, result.sender_user_id_)
end
database:set("SNIEBR:name_user:"..bot_id..msg.chat_id_..result.sender_user_id_,a[1])
...
ts_text = database:get("SNIEBR:all_if:"..apmd[1]..bot_id..msg.chat_id_)
if ts_text then 
function promote_by_username(extra, result, success)
if result.id_ then
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
...
database:sadd('SNIEBR:'..bot_id..'mods:'..msg.chat_id_, result.id_)
elseif ts_text == "عضو مميز" then 
database:sadd('SNIEBR:'..bot_id..'vipgp:'..msg.chat_id_, result.id_)
elseif ts_text == "مدير" then 
database:sadd('SNIEBR:'..bot_id..'owners:'..msg.chat_id_, result.id_)
end
database:set("SNIEBR:name_user:"..bot_id..msg.chat_id_..result.id_,apmd[1])
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(apmd[2] or 'SNIEBRTEAM')..')\n☑┇تم رفعه '..apmd[1]
else
texts = '✖┇خطاء'
end
...
database:sadd('SNIEBR:'..bot_id..'mods:'..msg.chat_id_, apmd[2])
elseif ts_text == "عضو مميز" then 
database:sadd('SNIEBR:'..bot_id..'vipgp:'..msg.chat_id_, apmd[2])
elseif ts_text == "مدير" then 
database:sadd('SNIEBR:'..bot_id..'owners:'..msg.chat_id_, apmd[2])
end
database:set("SNIEBR:name_user:"..bot_id..msg.chat_id_..apmd[2],apmd[1])
...
function demote_by_reply(extra, result, success)
if ts_text == "ادمن" then 
database:srem('SNIEBR:'..bot_id..'mods:'..msg.chat_id_, result.sender_user_id_)
elseif ts_text == "عضو مميز" then 
database:srem('SNIEBR:'..bot_id..'vipgp:'..msg.chat_id_, result.sender_user_id_)
elseif ts_text == "مدير" then 
database:srem('SNIEBR:'..bot_id..'owners:'..msg.chat_id_, result.sender_user_id_)
end
database:del("SNIEBR:name_user:"..bot_id..msg.chat_id_..result.sender_user_id_)
...
if ts_text == "ادمن" then 
database:srem('SNIEBR:'..bot_id..'mods:'..msg.chat_id_, result.id_)
elseif ts_text == "عضو مميز" then 
database:srem('SNIEBR:'..bot_id..'vipgp:'..msg.chat_id_, result.id_)
elseif ts_text == "مدير" then 
database:srem('SNIEBR:'..bot_id..'owners:'..msg.chat_id_, result.id_)
end
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(apmd[2] or 'SNIEBRTEAM')..')\n🔰┇تم تنزيله من '..apmd[1]
database:del("SNIEBR:name_user:"..bot_id..msg.chat_id_..result.id_)
else
texts = '✖┇خطاء'
end
send(msg.chat_id_, msg.id_, 1, texts, 1, 'md')
...
database:sadd('SNIEBR:'..bot_id.."filtersteckr"..msg.chat_id_,idsticker)
text = 'الملصق'
...
database:sadd('SNIEBR:'..bot_id.."filterphoto"..msg.chat_id_,photo)
text = 'الصوره'
sendtext(msg.chat_id_, msg.id_,textt..'( '..text..' ) بنجاح لن يتم ارسالها مجددا')  
return false
end
...
database:sadd('SNIEBR:'..bot_id.."filteranimation"..msg.chat_id_,idanimation)
text = 'المتحركه'
sendtext(msg.chat_id_, msg.id_,textt..'( '..text..' ) بنجاح لن يتم ارسالها مجددا')  
return false
end
...
if b.content_.sticker_ then
local idsticker = b.content_.sticker_.set_id_
database:srem('SNIEBR:'..bot_id.."filtersteckr"..msg.chat_id_,idsticker)
text = 'الملصق'
...
if b.content_.ID == "MessagePhoto" then
local photo = b.content_.photo_.id_
database:srem('SNIEBR:'..bot_id.."filterphoto"..msg.chat_id_,photo)
text = 'الصوره'
sendtext(msg.chat_id_, msg.id_,textt..'( '..text..' ) بنجاح يمكنهم الارسال الان')  
return false
end
if b.content_.animation_.animation_ then
local idanimation = b.content_.animation_.animation_.persistent_id_
database:srem('SNIEBR:'..bot_id.."filteranimation"..msg.chat_id_,idanimation)
text = 'المتحركه'
sendtext(msg.chat_id_, msg.id_,textt..'( '..text..' ) بنجاح يمكنهم الارسال الان')  
return false
end
...
database:set('SNIEBR:'..bot_id..'lock_geam'..msg.chat_id_,true)  
end
...
database:del('SNIEBR:'..bot_id..'lock_geam'..msg.chat_id_) 
end
...
local tsX_o = database:get("lock_tag:SNIEBR"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"🔐┇ بالفعل تم قفل التاك ")
else
tsX000("lock",msg,"🔐┇ تم قفل التاك ")
database:set("lock_tag:SNIEBR"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "قفل الرد") then
local tsX_o = database:get("lock_reple:SNIEBR"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"🔐┇ بالفعل تم قفل الرد على الرسائل ")
else
tsX000("lock",msg,"🔐┇ تم قفل الرد على الرسائل ")
database:set("lock_reple:SNIEBR"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "قفل الشارحه") then
local tsX_o = database:get("lock_sarha:SNIEBR"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"🔐┇ بالفعل تم قفل الشارحه ")
else
tsX000("lock",msg,"🔐┇ تم قفل الشارحه ")
database:set("lock_sarha:SNIEBR"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "قفل الكلايش") then
local tsX_o = database:get("lock_word:SNIEBR"..msg.chat_id_..bot_id)
if tsX_o then
...
local tsX_o = database:get("lock_lllll:SNIEBR"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"🔐┇ بالفعل تم قفل التكرار ")
else
tsX000("lock",msg,"🔐┇ تم قفل التكرار ")
database:set("lock_lllll:SNIEBR"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "قفل المتحركه") then
local tsX_o = database:get("lock_gif:SNIEBR"..msg.chat_id_..bot_id)
if tsX_o then
...
local tsX_o = database:get("lock_files:SNIEBR"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"🔐┇ بالفعل تم قفل الملفات ")
else
tsX000("lock",msg,"🔐┇ تم قفل الملفات ")
database:set("lock_files:SNIEBR"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "قفل الماركدون") then
local tsX_o = database:get("lock_mark:SNIEBR"..msg.chat_id_..bot_id)
if tsX_o then
...
local tsX_o = database:get("lock_photo:SNIEBR"..msg.chat_id_..bot_id)
if tsX_o then
...
local tsX_o = database:get("lock_stecker:SNIEBR"..msg.chat_id_..bot_id)
if tsX_o then
...
local tsX_o = database:get("lock_video:SNIEBR"..msg.chat_id_..bot_id)
if tsX_o then
...
local tsX_o = database:get("lock_inline:SNIEBR"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"🔐┇ بالفعل تم قفل الانلاين ")
else
tsX000("lock",msg,"🔐┇ تم قفل الانلاين ")
database:set("lock_inline:SNIEBR"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "قفل الدردشه") then
local tsX_o = database:get("lock_chat:SNIEBR"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"🔐┇ بالفعل تم قفل الدردشه ")
else
tsX000("lock",msg,"🔐┇ تم قفل الدردشه ")
database:set("lock_chat:SNIEBR"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "قفل التوجيه") then
local tsX_o = database:get("lock_fwd:SNIEBR"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"🔐┇ بالفعل تم قفل التوجيه ")
else
tsX000("lock",msg,"🔐┇ تم قفل التوجيه ")
database:set("lock_fwd:SNIEBR"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "قفل التثبيت") then
local tsX_o = database:get("lock_pin:SNIEBR"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"🔐┇ بالفعل تم قفل التثبيت ")
else
tsX000("lock",msg,"🔐┇ تم قفل التثبيت ")
database:set("lock_pin:SNIEBR"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "قفل الاغاني") then
local tsX_o = database:get("lock_audeo:SNIEBR"..msg.chat_id_..bot_id)
if tsX_o then
...
local tsX_o = database:get("lock_voice:SNIEBR"..msg.chat_id_..bot_id)
if tsX_o then
...
local tsX_o = database:get("lock_contact:SNIEBR"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"🔐┇ بالفعل تم قفل الجهات ")
else
tsX000("lock",msg,"🔐┇ تم قفل الجهات ")
database:set("lock_contact:SNIEBR"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "قفل العربيه") then
local tsX_o = database:get("lock_ar:SNIEBR"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"🔐┇ بالفعل تم قفل العربيه ")
else
tsX000("lock",msg,"🔐┇ تم قفل العربيه ")
database:set("lock_ar:SNIEBR"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "قفل الانكليزيه") then
local tsX_o = database:get("lock_en:SNIEBR"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"🔐┇ بالفعل تم قفل الانكليزيه ")
else
tsX000("lock",msg,"🔐┇ تم قفل الانكليزيه ")
database:set("lock_en:SNIEBR"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "قفل الميديا") then
local tsX_o = database:get("lock_media:SNIEBR"..msg.chat_id_..bot_id)
if tsX_o then
...
local tsX_o = database:get("lock_link:SNIEBR"..msg.chat_id_..bot_id)
if tsX_o then
...
local tsX_o = database:get("lock_username:SNIEBR"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"🔐┇ بالفعل تم قفل المعرف ")
else
tsX000("lock",msg,"🔐┇ تم قفل المعرف ")
database:set("lock_username:SNIEBR"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "قفل الاشعارات") then
local tsX_o = database:get("lock_new:SNIEBR"..msg.chat_id_..bot_id)
if tsX_o then
...
local tsX_o = database:get("lock_botAndBan:SNIEBR"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"🔐┇ بالفعل تم قفل البوتات بالطرد ")
else
tsX000("lock",msg,"🔐┇ تم قفل البوتات بالطرد ")
database:set("lock_botAndBan:SNIEBR"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "قفل البوتات") then
local tsX_o = database:get("lock_bot:SNIEBR"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"🔐┇ بالفعل تم قفل البوتات ")
else
tsX000("lock",msg,"🔐┇ تم قفل البوتات ")
database:set("lock_bot:SNIEBR"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "قفل الدخول") then
local tsX_o = database:get("lock_join:SNIEBR"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"🔐┇ بالفعل تم قفل الدخول للمجموعه ")
else
tsX000("lock",msg,"🔐┇ تم قفل الدخول للمجموعه ")
database:set("lock_join:SNIEBR"..msg.chat_id_..bot_id,"ok")
end
end
if (text == "قفل بصمه الفيديو") then
local tsX_o = database:get("lock_note:SNIEBR"..msg.chat_id_..bot_id)
if tsX_o then
...
database:del("lock_tag:SNIEBR"..msg.chat_id_..bot_id,"ok")
database:del("lock_sarha:SNIEBR"..msg.chat_id_..bot_id,"ok")
database:del("lock_word:SNIEBR"..msg.chat_id_..bot_id,"ok")
database:del("lock_lllll:SNIEBR"..msg.chat_id_..bot_id,"ok")
database:del("lock_gif:SNIEBR"..msg.chat_id_..bot_id,"ok")
database:del("lock_files:SNIEBR"..msg.chat_id_..bot_id,"ok")
database:del("lock_mark:SNIEBR"..msg.chat_id_..bot_id,"ok")
database:del("lock_photo:SNIEBR"..msg.chat_id_..bot_id,"ok")
database:del("lock_stecker:SNIEBR"..msg.chat_id_..bot_id,"ok")
database:del("lock_video:SNIEBR"..msg.chat_id_..bot_id,"ok")
database:del("lock_audeo:SNIEBR"..msg.chat_id_..bot_id,"ok")
database:del("lock_voice:SNIEBR"..msg.chat_id_..bot_id,"ok")
database:del("lock_contact:SNIEBR"..msg.chat_id_..bot_id,"ok")
database:del("lock_fwd:SNIEBR"..msg.chat_id_..bot_id,"ok")
database:del("lock_link:SNIEBR"..msg.chat_id_..bot_id,"ok")
database:del("lock_username:SNIEBR"..msg.chat_id_..bot_id,"ok")
database:del("lock_botAndBan:SNIEBR"..msg.chat_id_..bot_id,"ok")
database:del("lock_new:SNIEBR"..msg.chat_id_..bot_id,"ok")
...
database:del("lock_reple:SNIEBR"..msg.chat_id_..bot_id,"ok")
end
end
...
database:del("lock_word:SNIEBR"..msg.chat_id_..bot_id)
end
end
...
database:del("lock_inline:SNIEBR"..msg.chat_id_..bot_id,"ok")
end
end
...
database:del("lock_chat:SNIEBR"..msg.chat_id_..bot_id,"ok")
end
end
...
database:del("lock_pin:SNIEBR"..msg.chat_id_..bot_id,"ok")
end
end
...
database:del("lock_ar:SNIEBR"..msg.chat_id_..bot_id,"ok")
end
end
...
database:del("lock_en:SNIEBR"..msg.chat_id_..bot_id,"ok")
end
end
...
database:del("lock_media:SNIEBR"..msg.chat_id_..bot_id,"ok")
database:del("lock_audeo:SNIEBR"..msg.chat_id_..bot_id,"ok")
database:del("lock_video:SNIEBR"..msg.chat_id_..bot_id,"ok")
database:del("lock_photo:SNIEBR"..msg.chat_id_..bot_id,"ok")
database:del("lock_stecker:SNIEBR"..msg.chat_id_..bot_id,"ok")
database:del("lock_voice:SNIEBR"..msg.chat_id_..bot_id,"ok")
database:del("lock_gif:SNIEBR"..msg.chat_id_..bot_id,"ok")
database:del("lock_note:SNIEBR"..msg.chat_id_..bot_id,"ok")
end
end
...
database:del("lock_join:SNIEBR"..msg.chat_id_..bot_id,"ok")
end
end
...
database:del("lock_bot:SNIEBR"..msg.chat_id_..bot_id,"ok")
end
end
if text and text:match('^وضع عدد الكانسر (%d+)$') then
local Num = text:match('^وضع عدد الكانسر (%d+)$')
database:set('SNIEBR:'..bot_id..'Num:kansers'..msg.chat_id_,Num)
send(msg.chat_id_, msg.id_, 1, '\n🔖┇تم وضع عدد حروف الاسم {'..Num..'} حرف',1, 'md')
end
if (text == "قفل الكانسر") then
local tsX_o = database:get("lock_kansers:SNIEBR"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"🔐┇ بالفعل تم قفل الكانسر ")
else
tsX000("lock",msg,"🔐┇ تم قفل الكانسر ")
database:set("lock_kansers:SNIEBR"..msg.chat_id_..bot_id,"ok")
end
end
...
database:del("lock_kansers:SNIEBR"..msg.chat_id_..bot_id,"ok")
end
end
...
if not is_creator(msg) and not is_setban(msg) and database:get("SNIEBR:lock:ban_and_kick"..bot_id..msg.chat_id_) then 
...
database:sadd('SNIEBR:'..bot_id..'banned:'..msg.chat_id_, result.id_)
...
database:sadd('SNIEBR:'..bot_id..'banned:'..msg.chat_id_, apba[2])
...
database:del('SNIEBR:'..bot_id..'banned:'..msg.chat_id_, result.id_)
database:del('SNIEBR:'..bot_id..'muted:'..msg.chat_id_, result.id_)
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(apba[2] or 'SNIEBRTEAM')..')\n☑┇تم تحريره من القيود'
end
send(msg.chat_id_, msg.id_, 1, texts, 1, 'md')
end
...
database:del('SNIEBR:'..bot_id..'banned:'..msg.chat_id_, apba[2])
database:del('SNIEBR:'..bot_id..'muted:'..msg.chat_id_, apba[2])
...
database:set('SNIEBR:'..bot_id.."group:link"..msg.chat_id_,glink) 
...
database:srem('SNIEBR:'..bot_id..'banned:'..msg.chat_id_, result.id_)
...
database:srem('SNIEBR:'..bot_id..'banned:'..msg.chat_id_, apba[2])
...
database:sadd('SNIEBR:'..bot_id..'muted:'..msg.chat_id_, result.id_)
...
database:sadd('SNIEBR:'..bot_id..'muted:'..msg.chat_id_, apsi[2])
...
if result.id_ then
database:srem('SNIEBR:'..bot_id..'muted:'..msg.chat_id_, result.id_)
...
database:srem('SNIEBR:'..bot_id..'muted:'..msg.chat_id_, apsi[2])
...
local SNIEBR_098 = 0
if database:get("SNIEBR:get:mod:"..bot_id..msg.chat_id_) then 
t = database:get("SNIEBR:get:mod:"..bot_id..msg.chat_id_)
...
database:set("SNIEBR:get:mod:"..bot_id..msg.chat_id_,t2.member_count_)   
end
tdcli_function ({
ID = "GetChannelFull",
channel_id_ = getChatId(msg.chat_id_).ID
...
database:set("ahmad:get:url:"..bot_id..msg.chat_id_..msg.sender_user_id_,true)
return "ahmad"
end
if text and database:get("ahmad:get:url:"..bot_id..msg.chat_id_..msg.sender_user_id_) and text:match("[Hh][Tt][Tt][pP]") then 
send(msg.chat_id_, msg.id_, 1, '☑┇تم وضع : ['..text..']', 1, 'md')
database:set('SNIEBR:'..bot_id.."group:link"..msg.chat_id_,text)
database:del("ahmad:get:url:"..bot_id..msg.chat_id_..msg.sender_user_id_,true)
return "ahmad"
end

if text == ("تفعيل الترحيب") then
send(msg.chat_id_, msg.id_, 1, '✔️┇تم تفعيل الترحيب في المجموعه', 1, 'md')
database:set('SNIEBR:'..bot_id.."welcome"..msg.chat_id_,true)
end
if text == ("تعطيل الترحيب") then
send(msg.chat_id_, msg.id_, 1, '🔌┇تم تعطيل الترحيب في المجموعه', 1, 'md')
database:del('SNIEBR:'..bot_id.."welcome"..msg.chat_id_)
end
if text and text:match("^وضع ترحيب (.*)$") then
local welcome = {string.match(text, "^(وضع ترحيب) (.*)$")}
send(msg.chat_id_, msg.id_, 1, '☑┇تم وضع ترحيب\n📜┇~⪼('..welcome[2]..')', 1, 'md')
database:set('SNIEBR:'..bot_id..'welcome:'..msg.chat_id_,welcome[2])
end
...
local wel = database:get('SNIEBR:'..bot_id..'welcome:'..msg.chat_id_)
if wel then
...
database:set("SNIEBR:not:word:"..bot_id..msg.chat_id_,SNIEBR_0[2])
end

if text == ("الاعدادات") then
if database:get("lock_media:SNIEBR"..msg.chat_id_..bot_id) then
mute_all = '✔┇'
else
mute_all = '✖┇'
end
...
------------
if not database:get('SNIEBR:'..bot_id..'flood:max:'..msg.chat_id_) then
flood_m = 10
else
flood_m = database:get('SNIEBR:'..bot_id..'flood:max:'..msg.chat_id_)
end
if not database:get( 'SNIEBR:'..bot_id..'flood:time:'..msg.chat_id_) then
flood_t = 10
else
flood_t = database:get( 'SNIEBR:'..bot_id..'flood:time:'..msg.chat_id_)
end
------------
if database:get("lock_audeo:SNIEBR"..msg.chat_id_..bot_id) then
mute_music = '✔┇'
...
------------
if database:get("lock_bot:SNIEBR"..msg.chat_id_..bot_id) then
mute_bots = '✔┇'
else
mute_bots = '✖┇'
end
...
------------
if database:get("lock_inline:SNIEBR"..msg.chat_id_..bot_id) then
mute_in = '✔┇'
else
mute_in = '✖┇'
end
...
------------
if database:get("lock_edit:SNIEBR"..msg.chat_id_..bot_id) then
mute_edit = '✔┇'
else
mute_edit = '✖┇'
end
...
------------
if database:get("lock_pin:SNIEBR"..msg.chat_id_..bot_id) then
lock_pin = '✔┇'
else
lock_pin = '✖┇'
end
...
if database:get('SNIEBR:'..bot_id..'rep:mute'..msg.chat_id_) then
lock_rep = '✔┇'
else
lock_rep = '✖┇'
end
...
------------
local ex = database:ttl( 'SNIEBR:'..bot_id.."charge:"..msg.chat_id_)
if ex == -1 then
exp_dat = 'لا نهائي'
else
...
local list = database:smembers('SNIEBR:'..bot_id.."repmedia"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del('SNIEBR:'..bot_id.."filtr1:add:reply1"..msg.sender_user_id_..msg.chat_id_)  
database:del('SNIEBR:'..bot_id.."filtr1:add:reply:rd"..v..msg.chat_id_)  
database:srem('SNIEBR:'..bot_id.."repmedia"..msg.chat_id_,v)  
end  
...
for k,v in pairs(list) do  
local taha = database:get('SNIEBR:'..bot_id.."filtr1:add:reply:rd"..v..msg.chat_id_)   
t = t..''..k..'- '..v..' » {'..taha..'}\n'    
end  
if #list == 0 then  
...
database:set('SNIEBR:'..bot_id.."filtr1:add:reply1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get('SNIEBR:'..bot_id.."filtr1:add:reply1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == 'rep' then   
send(msg.chat_id_, msg.id_, 1, "📥┇ ارسل تحذير عند ارسال الكلمه \n", 1, 'md')  
database:set('SNIEBR:'..bot_id.."filtr1:add:reply1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set('SNIEBR:'..bot_id.."filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd('SNIEBR:'..bot_id.."repmedia"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get('SNIEBR:'..bot_id.."filtr1:add:reply1"..msg.sender_user_id_..msg.chat_id_)  
if test == 'repp' then  
send(msg.chat_id_, msg.id_, 1, '🔖┇تم منع الكلمه لن يتم ارسالها بعد الان  \n', 1, 'md')  
database:del('SNIEBR:'..bot_id.."filtr1:add:reply1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get('SNIEBR:'..bot_id.."filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set('SNIEBR:'..bot_id.."filtr1:add:reply:rd"..test..msg.chat_id_, text)  
database:hset('SNIEBR:'..bot_id..'filters:'..msg.chat_id_, text, 'filtered')
end  
database:del('SNIEBR:'..bot_id.."filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end
...
database:set('SNIEBR:'..bot_id.."filtr1:add:reply1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get('SNIEBR:'..bot_id.."filtr1:add:reply1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del('SNIEBR:'..bot_id.."filtr1:add:reply1"..msg.sender_user_id_..msg.chat_id_)  
database:del('SNIEBR:'..bot_id.."filtr1:add:reply:rd"..text..msg.chat_id_)  
database:srem('SNIEBR:'..bot_id.."repmedia"..msg.chat_id_,text)  
return false  end  
end
...
database:set('SNIEBR:'..bot_id..'rules'..msg.chat_id_, txt[2])
...
database:set('SNIEBR:'..bot_id..'setphoto'..msg.chat_id_..':'..msg.sender_user_id_,true)
...
local hash = 'SNIEBR:'..bot_id..'res:'..msg.chat_id_
local list = database:smembers(hash) 
for k,v in pairs(list) do database:del('SNIEBR:'..bot_id..'res:'..msg.chat_id_) 
...
database:sadd('SNIEBR:'..bot_id..'res:'..msg.chat_id_, result.id_)
...
database:sadd('SNIEBR:'..bot_id..'res:'..msg.chat_id_, apba[2])
...
local tsX_o = database:get("lock_tag.note:SNIEBR"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"☑️┇بالفعل تم قفل التاك بالتقييد")
else
tsX000("lock",msg,"☑️┇تم قفل التاك بالتقييد")
database:set("lock_tag.note:SNIEBR"..msg.chat_id_..bot_id,"ok")
end
end
------------------------------------------------------------------------
if (text == "قفل الشارحه بالتقيد") then
local tsX_o = database:get("lock_sarha.note:SNIEBR"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"☑️┇بالفعل تم قفل الشارحه بالتقييد")
else
tsX000("lock",msg,"☑️┇تم قفل الشارحه بالتقييد")
database:set("lock_sarha.note:SNIEBR"..msg.chat_id_..bot_id,"ok")
end
end
------------------------------------------------------------------------
if (text == "قفل المتحركه بالتقيد") then
local tsX_o = database:get("lock_gif.note:SNIEBR"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"☑️┇بالفعل تم قفل المتحركه بالتقييد")
else
tsX000("lock",msg,"☑️┇تم قفل المتحركه بالتقييد")
database:set("lock_gif.note:SNIEBR"..msg.chat_id_..bot_id,"ok")
end
end
------------------------------------------------------------------------
if (text == "قفل الملفات بالتقيد") then
local tsX_o = database:get("lock_files.note:SNIEBR"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"☑️┇بالفعل تم قفل الملفات بالتقييد")
else
tsX000("lock",msg,"☑️┇تم قفل الملفات بالتقييد")
database:set("lock_files.note:SNIEBR"..msg.chat_id_..bot_id,"ok")
end
end
------------------------------------------------------------------------
if (text == "قفل الماركدون بالتقيد") then
local tsX_o = database:get("lock_mark.note:SNIEBR"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"☑️┇بالفعل تم قفل الماكدون بالتقييد")
else
tsX000("lock",msg,"☑️┇تم قفل الماركدون بالتقييد")
database:set("lock_mark.note:SNIEBR"..msg.chat_id_..bot_id,"ok")
end
end
------------------------------------------------------------------------
if (text == "قفل الصور بالتقيد") then
local tsX_o = database:get("lock_photo.note:SNIEBR"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"☑️┇بالفعل تم قفل الصور بالتقييد")
else
tsX000("lock",msg,"☑️┇تم قفل الصور بالتقييد")
database:set("lock_photo.note:SNIEBR"..msg.chat_id_..bot_id,"ok")
end
end
------------------------------------------------------------------------
if (text == "قفل الملصقات بالتقيد") then
local tsX_o = database:get("lock_stecker.note:SNIEBR"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"☑️┇بالفعل تم قفل الملصقات بالتقييد")
else
tsX000("lock",msg,"☑️┇تم قفل الملصقات بالتقييد")
database:set("lock_stecker.note:SNIEBR"..msg.chat_id_..bot_id,"ok")
end
end
------------------------------------------------------------------------
if (text == "قفل الفيديو بالتقيد") then
local tsX_o = database:get("lock_video.note:SNIEBR"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"☑️┇بالفعل تم قفل الفيديو بالتقييد")
else
tsX000("lock",msg,"☑️┇تم قفل الفيديو بالتقييد")
database:set("lock_video.note:SNIEBR"..msg.chat_id_..bot_id,"ok")
end
end
------------------------------------------------------------------------
if (text == "قفل الانلاين بالتقيد") then
local tsX_o = database:get("lock_inline.note:SNIEBR"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"☑️┇بالفعل تم قفل الانلاين بالتقييد")
else
tsX000("lock",msg,"☑️┇تم قفل الانلاين بالتقييد")
database:set("lock_inline.note:SNIEBR"..msg.chat_id_..bot_id,"ok")
end
end
------------------------------------------------------------------------
if (text == "قفل الدردشه بالتقيد") then
local tsX_o = database:get("lock_chat.note:SNIEBR"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"☑️┇بالفعل تم قفل الدردشه بالتقييد")
else
tsX000("lock",msg,"☑️┇تم قفل الدردشه بالتقييد")
database:set("lock_chat.note:SNIEBR"..msg.chat_id_..bot_id,"ok")
end
end
------------------------------------------------------------------------
if (text == "قفل التوجيه بالتقيد") then
local tsX_o = database:get("lock_fwd.note:SNIEBR"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"☑️┇بالفعل تم قفل التوجيه بالتقييد")
else
tsX000("lock",msg,"☑️┇تم قفل التوجيه بالتقييد")
database:set("lock_fwd.note:SNIEBR"..msg.chat_id_..bot_id,"ok")
end
end
------------------------------------------------------------------------
if (text == "قفل الاغاني بالتقيد") then
local tsX_o = database:get("lock_audeo.note:SNIEBR"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"☑️┇بالفعل تم قفل الاغاني بالتقييد")
else
tsX000("lock",msg,"☑️┇تم قفل الاغاني بالتقييد")
database:set("lock_audeo.note:SNIEBR"..msg.chat_id_..bot_id,"ok")
end
end
------------------------------------------------------------------------
if (text == "قفل الصوت بالتقيد") then
local tsX_o = database:get("lock_voice.note:SNIEBR"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"☑️┇بالفعل تم قفل الصوت بالتقييد")
else
tsX000("lock",msg,"☑️┇تم قفل الصوت بالتقييد")
database:set("lock_voice.note:SNIEBR"..msg.chat_id_..bot_id,"ok")
end
end
------------------------------------------------------------------------
if (text == "قفل الجهات بالتقيد") then
local tsX_o = database:get("lock_contact.note:SNIEBR"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"☑️┇بالفعل تم قفل الجهات بالتقييد")
else
tsX000("lock",msg,"☑️┇تم قفل الجهات بالتقييد")
database:set("lock_contact.note:SNIEBR"..msg.chat_id_..bot_id,"ok")
end
end
------------------------------------------------------------------------
if (text == "قفل العربيه بالتقيد") then
local tsX_o = database:get("lock_ar.note:SNIEBR"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"☑️┇بالفعل تم قفل العربيه بالتقييد")
else
tsX000("lock",msg,"☑️┇تم قفل العربيه بالتقييد")
database:set("lock_ar.note:SNIEBR"..msg.chat_id_..bot_id,"ok")
end
end
------------------------------------------------------------------------
if (text == "قفل الانكليزيه بالتقيد") then
local tsX_o = database:get("lock_en.note:SNIEBR"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"☑️┇بالفعل تم قفل الانكليزيه بالتقييد")
else
tsX000("lock",msg,"☑️┇تم قفل الانكليزيه بالتقييد")
database:set("lock_en.note:SNIEBR"..msg.chat_id_..bot_id,"ok")
end
end
------------------------------------------------------------------------
if (text == "قفل الروابط بالتقيد") then
local tsX_o = database:get("lock_link.note:SNIEBR"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"☑️┇بالفعل تم قفل الروابط بالتقييد")
else
tsX000("lock",msg,"☑️┇تم قفل الروابط بالتقييد")
database:set("lock_link.note:SNIEBR"..msg.chat_id_..bot_id,"ok")
end
end
------------------------------------------------------------------------
if (text == "قفل المعرف بالتقيد") then
local tsX_o = database:get("lock_username.note:SNIEBR"..msg.chat_id_..bot_id)
if tsX_o then
 tsX000("lock",msg,"☑️┇بالفعل تم قفل المعرف بالتقييد")
else
tsX000("lock",msg,"☑️┇تم قفل المعرف بالتقييد")
database:set("lock_username.note:SNIEBR"..msg.chat_id_..bot_id,"ok")
end
end
------------------------------------------------------------------------
if (text == "قفل بصمه الفيديو بالتقيد") then
local tsX_o = database:get("lock_note.note:SNIEBR"..msg.chat_id_..bot_id)
if tsX_o then
tsX000("lock",msg,"☑️┇بالفعل تم قفل بصمه الفيديو بالتقييد")
else
tsX000("lock",msg,"☑️┇تم قفل بصمه الفيديو بالتقييد")
database:set("lock_note.note:SNIEBR"..msg.chat_id_..bot_id,"ok")
end
end
------------------------------------------------------------------------
...
database:del("lock_tag.note:SNIEBR"..msg.chat_id_..bot_id,"ok")
end
end
------------------------------------------------------------------------
...
database:del("lock_sarha.note:SNIEBR"..msg.chat_id_..bot_id,"ok")
end
end
------------------------------------------------------------------------
...
database:del("lock_gif.note:SNIEBR"..msg.chat_id_..bot_id,"ok")
end
end
------------------------------------------------------------------------
...
database:del("lock_files.note:SNIEBR"..msg.chat_id_..bot_id,"ok")
end
end
------------------------------------------------------------------------
...
database:del("lock_mark.note:SNIEBR"..msg.chat_id_..bot_id,"ok")
end
end
------------------------------------------------------------------------
...
database:del("lock_photo.note:SNIEBR"..msg.chat_id_..bot_id,"ok")
end
end
------------------------------------------------------------------------
...
database:del("lock_stecker.note:SNIEBR"..msg.chat_id_..bot_id,"ok")
end
end
------------------------------------------------------------------------
...
database:del("lock_video.note:SNIEBR"..msg.chat_id_..bot_id,"ok")
end
end
------------------------------------------------------------------------
...
database:del("lock_inline.note:SNIEBR"..msg.chat_id_..bot_id,"ok")
end
end
------------------------------------------------------------------------
...
database:del("lock_chat.note:SNIEBR"..msg.chat_id_..bot_id,"ok")
end
end
------------------------------------------------------------------------
...
database:del("lock_fwd.note:SNIEBR"..msg.chat_id_..bot_id,"ok")
end
end
------------------------------------------------------------------------
...
database:del("lock_audeo.note:SNIEBR"..msg.chat_id_..bot_id,"ok")
end
end
------------------------------------------------------------------------
...
database:del("lock_voice.note:SNIEBR"..msg.chat_id_..bot_id,"ok")
end
end
------------------------------------------------------------------------
...
database:del("lock_contact.note:SNIEBR"..msg.chat_id_..bot_id,"ok")
end
end
------------------------------------------------------------------------
...
database:del("lock_ar.note:SNIEBR"..msg.chat_id_..bot_id,"ok")
end
end
------------------------------------------------------------------------
...
database:del("lock_en.note:SNIEBR"..msg.chat_id_..bot_id,"ok")
end
end
------------------------------------------------------------------------
...
database:del("lock_username.note:SNIEBR"..msg.chat_id_..bot_id,"ok")
end
end
------------------------------------------------------------------------
...
database:del("lock_note.note:SNIEBR"..msg.chat_id_..bot_id,"ok")
end
end
------------------------------------------------------------------------
...
database:del("lock_link.note:SNIEBR"..msg.chat_id_..bot_id,"ok")
end
end
------------------------------------------------------------------------
...
if database:get("lock_audeo.note:SNIEBR"..msg.chat_id_..bot_id) then
 ...
 ------------
if database:get("lock_inline.note:SNIEBR"..msg.chat_id_..bot_id) then
 mute_in = '✔┇'
else
 mute_in = '✖┇'
 end
...
lock_tag = '✖┇'
 ...
 ------------
if database:get("lock_contact.note:SNIEBR"..msg.chat_id_..bot_id) then
lock_contact = '✔┇'
else
lock_contact = '✖┇'
 end
...
database:del('SNIEBR:'..bot_id..'banned:'..msg.chat_id_)
...
if database:sismember('SNIEBR:'..bot_id..'gbanned:',result.id_) then
kewd = 'محظور عام'
elseif database:sismember('SNIEBR:'..bot_id..'banned:'..msg.chat_id_,result.id_) then
kewd = 'محظور'
elseif database:sismember('SNIEBR:'..bot_id..'muted:'..msg.chat_id_,result.id_) then
kewd = 'مكتوم'
elseif database:sismember('SNIEBR:'..bot_id..'res'..msg.chat_id_,result.id_) then
kewd = 'مقيد'
else
kewd = ' لا يوجد'
end
...
if database:sismember('SNIEBR:'..bot_id..'creatorbasic:'..msg.chat_id_, result.id_) then
crr = 'منشئ اساسي ،' else crr = '' end
if database:sismember('SNIEBR:'..bot_id..'creator:'..msg.chat_id_, result.id_) then
cr = 'منشئ ،' else cr = '' end
if database:sismember('SNIEBR:'..bot_id..'owners:'..msg.chat_id_, result.id_) then
own = 'مدير ،' else own = '' end
if database:sismember('SNIEBR:'..bot_id..'mods:'..msg.chat_id_, result.id_) then
mod = 'ادمن ،' else mod = '' end
if database:sismember('SNIEBR:'..bot_id..'vipgp:'..msg.chat_id_, result.id_) then
vip = 'مميز ،' else vip = ''
end
...
database:srem('SNIEBR:'..bot_id..'dev', result.id_)
database:del('SNIEBR:'..bot_id..'sudoo'..result.id_..'', 'no')
database:srem('SNIEBR:'..bot_id..'creatorbasic:'..msg.chat_id_,result.id_)
database:srem('SNIEBR:'..bot_id..'creator:'..msg.chat_id_, result.id_)
database:srem('SNIEBR:'..bot_id..'owners:'..msg.chat_id_, result.id_)
database:srem('SNIEBR:'..bot_id..'mods:'..msg.chat_id_, result.id_)
database:srem('SNIEBR:'..bot_id..'vipgp:'..msg.chat_id_, result.id_)
...
if redis:sismember('SNIEBR:'..bot_id..'dev',result.sender_user_id_) then
dev = 'المطور ،' else dev = '' end
if database:sismember('SNIEBR:'..bot_id..'creatorbasic:'..msg.chat_id_, result.sender_user_id_) then
crr = 'منشئ اساسي ،' else crr = '' end
if database:sismember('SNIEBR:'..bot_id..'creator:'..msg.chat_id_, result.sender_user_id_) then
cr = 'منشئ ،' else cr = '' end
if database:sismember('SNIEBR:'..bot_id..'owners:'..msg.chat_id_, result.sender_user_id_) then
own = 'مدير ،' else own = '' end
if database:sismember('SNIEBR:'..bot_id..'mods:'..msg.chat_id_, result.sender_user_id_) then
mod = 'ادمن ،' else mod = '' end
if database:sismember('SNIEBR:'..bot_id..'vipgp:'..msg.chat_id_, result.sender_user_id_) then
vip = 'مميز ،' else vip = ''
end
...
if RemBot(msg.sender_user_id_,msg.chat_id_) == 'sudo1' then
database:srem('SNIEBR:'..bot_id..'dev', result.sender_user_id_)
database:del('SNIEBR:'..bot_id..'sudoo'..result.sender_user_id_..'', 'no')
database:srem('SNIEBR:'..bot_id..'creatorbasic:'..msg.chat_id_,result.sender_user_id_)
database:srem('SNIEBR:'..bot_id..'creator:'..msg.chat_id_, result.sender_user_id_)
database:srem('SNIEBR:'..bot_id..'owners:'..msg.chat_id_, result.sender_user_id_)
database:srem('SNIEBR:'..bot_id..'mods:'..msg.chat_id_, result.sender_user_id_)
database:srem('SNIEBR:'..bot_id..'vipgp:'..msg.chat_id_, result.sender_user_id_)
elseif RemBot(msg.sender_user_id_,msg.chat_id_) == 'sudo' then
...
------------------------------------------------------------------------
if (text and text == "ابلاغ" and msg.reply_to_message_id_ ~= 0 and (not database:get("SNIEBR:mute:deleta:msg:"..bot_id..msg.chat_id_))) then 
b = database:get("SNIEBR:user:deleteL:msg:"..msg.chat_id_..bot_id..msg.sender_user_id_)
if b and b == os.date("%x") then 
send(msg.chat_id_, msg.id_, 1, "👤┇ لا يمكنك الابلاغ اكثر من مره في اليوم", 1, 'html')
else
database:set("SNIEBR:user:deleteL:msg:"..msg.chat_id_..bot_id..msg.sender_user_id_,os.date("%x"))
...
t = database:get("SNIEBR:name_own"..bot_id..msg.chat_id_) or 'مدير الكروب '
elseif is_mod(msg) then
t = database:get("SNIEBR:name_adm"..bot_id..msg.chat_id_) or ' ادمن الكروب خالي '
elseif is_vip(msg) then
t = database:get("SNIEBR:name_vipp"..bot_id..msg.chat_id_) or 'عضو مميز '
else
t = database:get("SNIEBR:name_nk"..bot_id..msg.chat_id_) or 'عضو محد يحترمك' 
end
...
if not database:get('SNIEBR:'..bot_id..'id:mute'..msg.chat_id_) then 
local tahna = (database:get('SNIEBR:'..bot_id..'nummsg'..msg.chat_id_..result.sender_user_id_) or 0)
if tonumber((database:get('SNIEBR:'..bot_id..'add:numall'..msg.chat_id_..result.sender_user_id_) or 0)) == 0 then
nko = '0'
else
nko = (database:get('SNIEBR:'..bot_id..'add:numall'..msg.chat_id_..result.sender_user_id_))
end
local msgs = ((database:get('SNIEBR:'..bot_id..'user:msgs'..msg.chat_id_..':'..result.sender_user_id_) or 0) + tahna)
local edit = database:get('SNIEBR:'..bot_id..'user:editmsg'..msg.chat_id_..':'..result.sender_user_id_) or 0
local msg2 = msg
...
SNIEBR_oop = database:get("SNIEBR:name_sudo"..bot_id..msg.chat_id_)  or 'مطور البوت '
elseif is_creatorbasic(msg) then
SNIEBR_oop = database:get("SNIEBR:name_cre"..bot_id..msg.chat_id_) or 'منشئ اساسي '
elseif (database:get("SNIEBR:name_user:"..bot_id..msg.chat_id_..result.id_) and database:get("SNIEBR:all_if:"..database:get("SNIEBR:name_user:"..bot_id..msg.chat_id_..result.id_) ..bot_id..msg.chat_id_)) then 
SNIEBR_oop = database:get("SNIEBR:name_user:"..bot_id..msg.chat_id_..result.id_)
elseif is_creator(msg) then
SNIEBR_oop = database:get("SNIEBR:name_cre"..bot_id..msg.chat_id_) or 'منشئ الكروب '
elseif (database:get("SNIEBR:name_user:"..bot_id..msg.chat_id_..result.sender_user_id_) and database:get("SNIEBR:all_if:"..database:get("SNIEBR:name_user:"..bot_id..msg.chat_id_..result.sender_user_id_) ..bot_id..msg.chat_id_)) then 
SNIEBR_oop = database:get("SNIEBR:name_user:"..bot_id..msg.chat_id_..result.sender_user_id_)
elseif is_owner(msg2) then
SNIEBR_oop = database:get("SNIEBR:name_own"..bot_id..msg.chat_id_) or 'مدير الكروب '
elseif is_mod(msg2) then
SNIEBR_oop = database:get("SNIEBR:name_adm"..bot_id..msg.chat_id_) or 'ادمن الكروب'
elseif is_vip(msg2) then
SNIEBR_oop = database:get("SNIEBR:name_vipp"..bot_id..msg.chat_id_) or ' عضو مميز '
else
SNIEBR_oop = database:get("SNIEBR:name_nk"..bot_id..msg.chat_id_) or 'عضو فقط ' 
end
...
if result.id_ then
if not database:get('SNIEBR:'..bot_id..'id:mute'..msg.chat_id_) then 
local tahna = (database:get('SNIEBR:'..bot_id..'nummsg'..msg.chat_id_..result.id_) or 0)
if tonumber((database:get('SNIEBR:'..bot_id..'add:numall'..msg.chat_id_..result.id_) or 0)) == 0 then
nko = '0'
else
nko = (database:get('SNIEBR:'..bot_id..'add:numall'..msg.chat_id_..result.id_))
end
local msgs = ((database:get('SNIEBR:'..bot_id..'user:msgs'..msg.chat_id_..':'..result.id_) or 0) + tahna)
local edit = database:get('SNIEBR:'..bot_id..'user:editmsg'..msg.chat_id_..':'..result.id_) or 0
local msg2 = msg
msg2.sender_user_id_ = result.id_
local user_msgs = ((database:get('SNIEBR:'..bot_id..'user:msgs'..msg.chat_id_..':'..result.id_) or 0) + tahna)
local iahmad_text = "غير متفاعل"
if user_msgs then 
if tonumber(user_msgs) < 50 then 
iahmad_text = "غير متفاعل"
...
------------------------------------------------------------------------
if text == ("الرابط") then
if not database:get("SNIEBR:mute:link:gr:"..bot_id..msg.chat_id_) then 
function dl_cb222( t1,t2 )
if (database:get('SNIEBR:'..bot_id.."group:link"..msg.chat_id_) and database:get('SNIEBR:'..bot_id.."group:link"..msg.chat_id_) ~= "Error") then 
send(msg.chat_id_, msg.id_, 1, '📮┇ *رابط المجموعه* \n['..database:get('SNIEBR:'..bot_id.."group:link"..msg.chat_id_)..']', 1, "md")
...
database:set('SNIEBR:'..bot_id.."group:link"..msg.chat_id_,link.result)
else 
...
local user_msgs = database:get('SNIEBR:'..bot_id..'user:msgs'..msg.chat_id_..':'..msg.sender_user_id_)
local tahna = (database:get('SNIEBR:'..bot_id..'nummsg'..msg.chat_id_..msg.sender_user_id_) or 0)
if not database:get('SNIEBR:'..bot_id..'id:mute'..msg.chat_id_) then
...
------------------------------------------------------------------------
if text == ("جهاتي") then
add = (tonumber(database:get('SNIEBR:'..bot_id..'user:add'..msg.chat_id_..':'..msg.sender_user_id_)) or 0)
send(msg.chat_id_, msg.id_, 1, "📨┇عدد اضافه جهاتك ~⪼ *{"..add.."}*\n📨┇سيتم حذف العدد بعد هذه الرساله", 1, 'md')
database:del('SNIEBR:'..bot_id..'user:add'..msg.chat_id_..':'..msg.sender_user_id_)
end
...
database:del('SNIEBR:'..bot_id..'user:editmsg'..msg.chat_id_..':'..msg.sender_user_id_)
...
local rules = database:get('SNIEBR:'..bot_id..'rules'..msg.chat_id_)
if rules then
...
if not database:sismember('SNIEBR:'..bot_id..'spam:id'..msg.sender_user_id_..':'..msg.chat_id_,'ايدي') then
database:sadd('SNIEBR:'..bot_id..'spam:id'..msg.sender_user_id_..':'..msg.chat_id_,'ايدي')
local ahmad_info = nil
function ahmad333(extra,result,success)
ahmad_info = '@'..(result.username_ or 'لا يوجد')..''
...
local tahna = (database:get('SNIEBR:'..bot_id..'nummsg'..msg.chat_id_..msg.sender_user_id_) or 0)
if tonumber((database:get('SNIEBR:'..bot_id..'add:numall'..msg.chat_id_..msg.sender_user_id_) or 0)) == 0 then
nko = '0'
else
nko = (database:get('SNIEBR:'..bot_id..'add:numall'..msg.chat_id_..msg.sender_user_id_))
end
local user_msgs = ((database:get('SNIEBR:'..bot_id..'user:msgs'..msg.chat_id_..':'..msg.sender_user_id_) or 0) + tahna)
local iahmad_text = "غير متفاعل"
if user_msgs then 
...
t = 'مطور سنايبر '
elseif is_sudo(msg) then
t = database:get("SNIEBR:name_sudo"..bot_id..msg.chat_id_)  or 'المطور 👨🏻‍🔧'
elseif is_creatorbasic(msg) then
t =  database:get("SNIEBR:name_cre"..bot_id..msg.chat_id_) or 'منشئ اساسي 👨🏻‍🚀'
elseif (database:get("SNIEBR:name_user:"..bot_id..msg.chat_id_..msg.sender_user_id_) and database:get("SNIEBR:all_if:"..database:get("SNIEBR:name_user:"..bot_id..msg.chat_id_..msg.sender_user_id_) ..bot_id..msg.chat_id_)) then 
t = database:get("SNIEBR:name_user:"..bot_id..msg.chat_id_..msg.sender_user_id_)
elseif is_creator(msg) then
t =  database:get("SNIEBR:name_cre"..bot_id..msg.chat_id_) or 'منشئ الكروب 👨🏻‍✈️'
elseif (database:get("SNIEBR:name_user:"..bot_id..msg.chat_id_..msg.sender_user_id_) and database:get("SNIEBR:all_if:"..database:get("SNIEBR:name_user:"..bot_id..msg.chat_id_..msg.sender_user_id_) ..bot_id..msg.chat_id_)) then 
t = database:get("SNIEBR:name_user:"..bot_id..msg.chat_id_..msg.sender_user_id_)
elseif is_owner(msg) then
t = database:get("SNIEBR:name_own"..bot_id..msg.chat_id_) or 'مدير الكروب 🏻'   
...
if not database:get('SNIEBR:'..bot_id..'id:mute'..msg.chat_id_) then
if not database:get('SNIEBR:'..bot_id..'id:photo'..msg.chat_id_) then
if not database:get("SNIEBR:gr:id:text:"..bot_id..msg.chat_id_) then 
local ahmad_text = {
'صورتك فدشي 😘😔❤️  ',
"صارلك شكد مخليه ",
...
local SNIEBR_new_text = database:get("SNIEBR:gr:id:text:"..bot_id..msg.chat_id_)
...
------------------------------------------------------------------------
if text then
if database:sismember('SNIEBR:'..bot_id..'spam:id'..msg.sender_user_id_..':'..msg.chat_id_,text) then
else
database:del('SNIEBR:'..bot_id..'spam:id'..msg.sender_user_id_..':'..msg.chat_id_) 
end
end
...
database:set('SNIEBR:'..bot_id..'viewget'..msg.sender_user_id_,true)
...
------------------------------------------------------------------------
if text == 'سمايلات' and database:get('SNIEBR:'..bot_id..'lock_geam'..msg.chat_id_) then
database:del('SNIEBR:'..bot_id..'l:ids'..msg.chat_id_)
katu = {'🍏','🍎','🍐','🍊','🍋','🍉','🍇','🍓','🍈','🍒','🍑','🍍','🥥','🥝','🍅','🍆','🥑','🥦','🥒','🌶','🌽','🥕','🥔','🥖','🥐','🍞','🥨','🍟','🧀','🥚','🍳','🥞','🥓','🥩','🍗','🍖','🌭','🍔','🍠','🍕','🥪','🥙','🍼','☕️','🍵','🥤','🍶','🍺','🍻','🏀','⚽️','🏈','⚾️','🎾','🏐','🏉','🎱','🏓','🏸','🥅','🎰','🎮','🎳','🎯','🎲','🎻','🎸','🎺','🥁','🎹','🎼','🎧','🎤','🎬','🎨','🎭','🎪','🎟','🎫','🎗','🏵','🎖','🏆','🥌','🛷','🚗','🚙','🚌','🚎','🏎','🚓','🚑','🚚','🚛','🚜','🇮🇶','⚔','🛡','🔮','🌡','💣','📌','📍','📓','📗','📂','📅','📪','📫','📬','📭','⏰','📺','🎚','☎️','📡'}
name = katu[math.random(#katu)]
database:set('SNIEBR:'..bot_id..'klmos'..msg.chat_id_,name)
taha = '🚀┇اسرع واحد يدز » {`'..name..'`}'
send(msg.chat_id_, msg.id_, 1,taha, 1, 'md')
end
------------------------------------------------------------------------
if text == ''..(database:get('SNIEBR:'..bot_id..'klmos'..msg.chat_id_) or 'لفاتع')..'' and not database:get('SNIEBR:'..bot_id..'l:ids'..msg.chat_id_) then
if not database:get('SNIEBR:'..bot_id..'l:ids'..msg.chat_id_) then 
taha = '*👾| مبروك لقد فزت ,\n🎮| للعب مره اخرى ارسل سمايلات ,*'
send(msg.chat_id_, msg.id_, 1,taha, 1, 'md')
database:incrby('SNIEBR:'..bot_id..'add:num'..msg.chat_id_..msg.sender_user_id_, 1)  
database:incrby('SNIEBR:'..bot_id..'add:numall'..msg.chat_id_..msg.sender_user_id_, 1)    
end
database:set('SNIEBR:'..bot_id..'l:ids'..msg.chat_id_,true)
end 
------------------------------------------------------------------------
if text == 'الاسرع' and database:get('SNIEBR:'..bot_id..'lock_geam'..msg.chat_id_) then
database:del('SNIEBR:'..bot_id..'l:id'..msg.chat_id_)
...
name = katu[math.random(#katu)]
database:set('SNIEBR:'..bot_id..'klmo'..msg.chat_id_,name)
...
------------------------------------------------------------------------
if text == ''..(database:get('SNIEBR:'..bot_id..'klmo'..msg.chat_id_) or 'لفاتع')..'' and not database:get('SNIEBR:'..bot_id..'l:id'..msg.chat_id_) then
if not database:get('SNIEBR:'..bot_id..'l:id'..msg.chat_id_) then 
taha = '*👾| مبروك لقد فزت ,\n🎮| للعب مره اخرى ارسل الاسرع ,*'
send(msg.chat_id_, msg.id_, 1,taha, 1, 'md')
database:incrby('SNIEBR:'..bot_id..'add:num'..msg.chat_id_..msg.sender_user_id_, 1) 
database:incrby('SNIEBR:'..bot_id..'add:numall'..msg.chat_id_..msg.sender_user_id_, 1)    
end
database:set('SNIEBR:'..bot_id..'l:id'..msg.chat_id_,true)
end 
------------------------------------------------------------------------
if text == 'حزوره' and database:get('SNIEBR:'..bot_id..'lock_geam'..msg.chat_id_) then
database:del('SNIEBR:'..bot_id..'l:id1'..msg.chat_id_)
...
name = katu[math.random(#katu)]
database:set('SNIEBR:'..bot_id..'klmoa'..msg.chat_id_,name)
...
------------------------------------------------------------------------
if text == ''..(database:get('SNIEBR:'..bot_id..'klmoa'..msg.chat_id_) or 'لفاتع')..'' and not database:get('SNIEBR:'..bot_id..'l:id1'..msg.chat_id_) then
if not database:get('SNIEBR:'..bot_id..'l:id1'..msg.chat_id_) then 
taha = '*👾| مبروك لقد فزت ,\n🎮| للعب مره اخرى ارسل حزوره ,*'
send(msg.chat_id_, msg.id_, 1,taha, 1, 'md')
database:incrby('SNIEBR:'..bot_id..'add:num'..msg.chat_id_..msg.sender_user_id_, 1)
database:incrby('SNIEBR:'..bot_id..'add:numall'..msg.chat_id_..msg.sender_user_id_, 1)    
end
database:set('SNIEBR:'..bot_id..'l:id1'..msg.chat_id_,true)
end 
------------------------------------------------------------------------
if text == 'المعاني' and database:get('SNIEBR:'..bot_id..'lock_geam'..msg.chat_id_) then
database:del('SNIEBR:'..bot_id..'l:id2'..msg.chat_id_)
...
name = katu[math.random(#katu)]
database:set('SNIEBR:'..bot_id..'means'..msg.chat_id_,name)
...
------------------------------------------------------------------------
if text == ''..(database:get('SNIEBR:'..bot_id..'means'..msg.chat_id_) or 'لفاتع')..'' and not database:get('SNIEBR:'..bot_id..'l:id2'..msg.chat_id_) then
if not database:get('SNIEBR:'..bot_id..'l:id2'..msg.chat_id_) then 
taha = '*👾| مبروك لقد فزت ,\n🎮| للعب مره اخرى ارسل المعاني ,*'
send(msg.chat_id_, msg.id_, 1,taha, 1, 'md')
database:incrby('SNIEBR:'..bot_id..'add:num'..msg.chat_id_..msg.sender_user_id_, 1)
database:incrby('SNIEBR:'..bot_id..'add:numall'..msg.chat_id_..msg.sender_user_id_, 1)    
end
database:set('SNIEBR:'..bot_id..'l:id2'..msg.chat_id_,true)
end 
------------------------------------------------------------------------
if text == 'العكس' and database:get('SNIEBR:'..bot_id..'lock_geam'..msg.chat_id_) then
database:del('SNIEBR:'..bot_id..'l:id3'..msg.chat_id_)
katu = {'باي','فهمت','موزين','اسمعك','احبك','موحلو','نضيف','حاره','ناصي','جوه','سريع','ونسه','طويل','سمين','ضعيف','شريف','شجاع','رحت','عدل','نشيط','شبعان','موعطشان','خوش ولد','اني','هادئ'}
name = katu[math.random(#katu)]
database:set('SNIEBR:'..bot_id..'aks'..msg.chat_id_,name)
...
------------------------------------------------------------------------
if text == ''..(database:get('SNIEBR:'..bot_id..'aks'..msg.chat_id_) or 'لفاتع')..'' and not database:get('SNIEBR:'..bot_id..'l:id3'..msg.chat_id_) then
if not database:get('SNIEBR:'..bot_id..'l:id3'..msg.chat_id_) then 
taha = '*👾| مبروك لقد فزت ,\n🎮| للعب مره اخرى ارسل العكس ,*'
send(msg.chat_id_, msg.id_, 1,taha, 1, 'md')
database:incrby('SNIEBR:'..bot_id..'add:num'..msg.chat_id_..msg.sender_user_id_, 1)
database:incrby('SNIEBR:'..bot_id..'add:numall'..msg.chat_id_..msg.sender_user_id_, 1)    
end
database:set('SNIEBR:'..bot_id..'l:id3'..msg.chat_id_,true)
end 
------------------------------------------------------------------------
if database:get('SNIEBR:'..bot_id.."GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
...
send(msg.chat_id_, msg.id_, 1,taha, 1, 'md')
return false  end 
local GETNUM = database:get('SNIEBR:'..bot_id.."GAMES:NUM"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
database:del('SNIEBR:'..bot_id..'SADD:NUM'..msg.chat_id_..msg.sender_user_id_)
database:del('SNIEBR:'..bot_id.."GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
database:incrby('SNIEBR:'..bot_id..'add:num'..msg.chat_id_..msg.sender_user_id_, 5)  
database:incrby('SNIEBR:'..bot_id..'add:numall'..msg.chat_id_..msg.sender_user_id_, 5)    
taha = '*🔖┇ مبروك فزت ويانه وخمنت الرقم الصحيح\n🚸┇ تم اضافة { 5 } من النقاط *\n'
send(msg.chat_id_, msg.id_, 1,taha, 1, 'md')
elseif tonumber(NUM) ~= tonumber(GETNUM) then
database:incrby('SNIEBR:'..bot_id..'SADD:NUM'..msg.chat_id_..msg.sender_user_id_,1)
if tonumber(database:get('SNIEBR:'..bot_id..'SADD:NUM'..msg.chat_id_..msg.sender_user_id_)) >= 3 then
database:del('SNIEBR:'..bot_id..'SADD:NUM'..msg.chat_id_..msg.sender_user_id_)
database:del('SNIEBR:'..bot_id.."GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
...
------------------------------------------------------------------------
if database:get('SNIEBR:'..bot_id.."SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
...
send(msg.chat_id_, msg.id_, 1,taha, 1, 'md')
return false  end 
local GETNUM = database:get('SNIEBR:'..bot_id.."GAMES"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
database:del('SNIEBR:'..bot_id.."SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
taha = '*📮┇ مبروك فزت وطلعت المحيبس بل ايد رقم { '..NUM..' }\n🎊┇ لقد حصلت على { 3 }من نقاط يمكنك استبدالهن برسائل *'
send(msg.chat_id_, msg.id_, 1,taha, 1, 'md')
database:incrby('SNIEBR:'..bot_id..'add:num'..msg.chat_id_..msg.sender_user_id_, 3)  
database:incrby('SNIEBR:'..bot_id..'add:numall'..msg.chat_id_..msg.sender_user_id_, 3)    
elseif tonumber(NUM) ~= tonumber(GETNUM) then
database:del('SNIEBR:'..bot_id.."SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
...
------------------------------------------------------------------------
if text == 'المختلف' and database:get('SNIEBR:'..bot_id..'lock_geam'..msg.chat_id_) then
katu = {'😸','☠','🐼','🐇','🌑','🌚','⭐️','✨','⛈','🌥','⛄️','👨‍🔬','👨‍💻','👨‍🔧','👩‍🍳','🧚‍♀','🧜‍♂','🧝‍♂','🙍‍♂','🧖‍♂','👬','👨‍👨‍👧','🕒','🕤','⌛️','📅',
};
name = katu[math.random(#katu)]
database:del('SNIEBR:'..bot_id..'l:idss'..msg.chat_id_)
database:set('SNIEBR:'..bot_id..':Set_alii:'..msg.chat_id_,name)
...
------------------------------------------------------------------------
if text == 'امثله' and database:get('SNIEBR:'..bot_id..'lock_geam'..msg.chat_id_) then
katu = {
'جوز','ضراطه','الحبل','الحافي','شقره','بيدك','سلايه','النخله','الخيل','حداد','المبلل','يركص','قرد','العنب','العمه','الخبز','بالحصاد','شهر','شكه','يكحله',
};
name = katu[math.random(#katu)]
database:set('SNIEBR:'..bot_id..':Set_Amthlh:'..msg.chat_id_,name)
database:del('SNIEBR:'..bot_id..'l:idst'..msg.chat_id_)
...
------------------------------------------------------------------------
if text == ''..(database:get('SNIEBR:'..bot_id..':Set_alii:'..msg.chat_id_) or '57999')..'' then -- // المختلف
if not database:get('SNIEBR:'..bot_id..'l:idss'..msg.chat_id_) then 
database:incrby('SNIEBR:'..bot_id..'add:num'..msg.chat_id_..msg.sender_user_id_, 1)  
database:incrby('SNIEBR:'..bot_id..'add:numall'..msg.chat_id_..msg.sender_user_id_, 1)    
database:del('SNIEBR:'..bot_id..':Set_alii:'..msg.chat_id_)
taha = '*  🎁  احسنت اجابتك صحيحه   \n* '
send(msg.chat_id_, msg.id_, 1,taha, 1, 'md')
end
database:set('SNIEBR:'..bot_id..'l:idss'..msg.chat_id_,true)
end
------------------------------------------------------------------------
if text == ''..(database:get('SNIEBR:'..bot_id..':Set_Amthlh:'..msg.chat_id_) or '6499')..'' then -- // امثله
if not database:get('SNIEBR:'..bot_id..'l:idst'..msg.chat_id_) then 
database:incrby('SNIEBR:'..bot_id..'add:num'..msg.chat_id_..msg.sender_user_id_, 1)  
database:incrby('SNIEBR:'..bot_id..'add:numall'..msg.chat_id_..msg.sender_user_id_, 1)    
database:del('SNIEBR:'..bot_id..':Set_Amthlh:'..msg.chat_id_)
taha = '*  🎁  احسنت اجابتك صحيحه   \n* '
send(msg.chat_id_, msg.id_, 1,taha, 1, 'md')
end
database:set('SNIEBR:'..bot_id..'l:idst'..msg.chat_id_,true)
end
------------------------------------------------------------------------
if text == 'محيبس' or text == 'بات' then
if database:get('SNIEBR:'..bot_id..'lock_geam'..msg.chat_id_) then   
Num = math.random(1,6)
database:set('SNIEBR:'..bot_id.."GAMES"..msg.chat_id_,Num) 
TEST = [[
*➀       ➁     ➂      ➃      ➄     ➅
↓      ↓     ↓      ↓     ↓     ↓
👊 ‹› 👊 ‹› 👊 ‹› 👊 ‹› 👊 ‹› 👊
...
send(msg.chat_id_, msg.id_, 1,TEST, 1, 'md')
database:setex('SNIEBR:'..bot_id.."SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 100, true)  
return false  
end
end
------------------------------------------------------------------------
...
database:set('SNIEBR:'..bot_id.."GAMES:NUM"..msg.chat_id_,Num) 
TEST = '*\n🎮┇ اهلا بك عزيزي في لعبة التخمين :\nٴ━━━━━━━━━━\n'..'⚠┇ ملاحظه لديك { 3 } محاولات فقط فكر قبل ارسال تخمينك \n\n'..'🔖┇ سيتم تخمين عدد ما بين ال {1 و 20} اذا تعتقد انك تستطيع الفوز جرب واللعب الان ؟ \n💥*'
send(msg.chat_id_, msg.id_, 1,TEST, 1, 'md')
database:setex('SNIEBR:'..bot_id.."GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 100, true)  
return false  
end
end
------------------------------------------------------------------------
if text =='مجوهراتي' then 
if tonumber((database:get('SNIEBR:'..bot_id..'add:num'..msg.chat_id_..msg.sender_user_id_) or 0)) == 0 then
taha = '*💎┇ ليس لديك مجوهرات \n📬┇ للحصول على مجوهرات ارسل الاسرع وابدأ اللعب*\n'
send(msg.chat_id_, msg.id_, 1,taha, 1, 'md')
else
taha = '*💎┇ عدد مجوهراتك الحاليه  ('..(database:get('SNIEBR:'..bot_id..'add:num'..msg.chat_id_..msg.sender_user_id_))..')*'
taha1 = '*💎┇ مجموع مجوهراتك  ('..(database:get('SNIEBR:'..bot_id..'add:numall'..msg.chat_id_..msg.sender_user_id_))..')*'
...
taha = (database:get('SNIEBR:'..bot_id..'add:num'..msg.chat_id_..msg.sender_user_id_) * tonumber(database:get('SNIEBR:'..bot_id..'gamepoint' .. msg.chat_id_)or 50))
database:incrby('SNIEBR:'..bot_id..'nummsg'..msg.chat_id_..msg.sender_user_id_,taha)  
database:del('SNIEBR:'..bot_id..'add:num'..msg.chat_id_..msg.sender_user_id_)
taha = tonumber((database:get('SNIEBR:'..bot_id..'gamepoint' .. msg.chat_id_) or 50))
...
database:del('SNIEBR:'..bot_id..'add:num'..msg.chat_id_..msg.sender_user_id_)  
database:del('SNIEBR:'..bot_id..'add:numall'..msg.chat_id_..msg.sender_user_id_)  
send(msg.chat_id_, msg.id_, 1, "تم حذف جميع مجوهراتك", 1, "md") 
end
------------------------------------------------------------------------
if text == 'حذف رسائلي' then
database:del('SNIEBR:'..bot_id..'nummsg'..msg.chat_id_..msg.sender_user_id_)
database:del('SNIEBR:'..bot_id..'user:msgs'..msg.chat_id_..':'..msg.sender_user_id_)
...
database:del( 'SNIEBR:'..bot_id.."charge:"..'-100'..data.channel_.id_)
database:srem("SNEBR:gog"..bot_id, '-100'..data.channel_.id_)
database:sadd( 'SNIEBR:'..bot_id.."groups",'-100'..data.channel_.id_)
end
end
local chat = {}
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
database:hset('SNIEBR:'..bot_id..'user:'..msg.sender_user_id_,'username',(data.username_ or msg.sender_user_id_))
...
if database:get("lock_botAndBan:SNIEBR"..msg.chat_id_..bot_id) and not bot_id then
changeChatMemberStatus(msg.chat_id_, msg.content_.members_[0].id_, "Kicked")
changeChatMemberStatus(msg.chat_id_, msg.sender_user_id_, "Kicked")
end
end
...
if database:get("SNIEBR:edit:text:su:new2:"..bot_id..data.message_.chat_id_..data.message_.content_.text_) then
local SNIEBR_edit_text = database:get("SNIEBR:edit:text:su:new2:"..bot_id..data.message_.chat_id_..data.message_.content_.text_)
...
local msgg = result 
database:incr('SNIEBR:'..bot_id..'user:editmsg'..msgg.chat_id_..':'..msgg.sender_user_id_)
...
if database:get("lock_edit:SNIEBR"..msg.chat_id_..bot_id) and not result.content_.text_ and not is_creator(msgg) and not is_creatorbasic(msgg) then
...
elseif database:get("lock_edit:SNIEBR:kick"..msg.chat_id_..bot_id) and not result.content_.text_ and not is_creator(msgg) and not is_creatorbasic(msgg) then
function get_edit(arg,data)
local username = data.username_
local name = data.first_name_
local iduser = data.id_
...
------------------------------------------------------------------------
local taha = database:get('SNIEBR:'..bot_id.."add:reply:rd"..text..msg.chat_id_)   
...
database:srem("SNEBR:gog"..bot_id,v) 
database:srem('SNIEBR:'..bot_id..'pro:groups',v) 
database:srem( 'SNIEBR:'..bot_id.."groups",v) 
end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusLeft" then
database:srem("SNEBR:gog"..bot_id,v) 
database:srem('SNIEBR:'..bot_id..'pro:groups',v) 
...
database:sadd("SNEBR:gog"..bot_id,v) 
database:sadd('SNIEBR:'..bot_id..'pro:groups',v) 
database:sadd( 'SNIEBR:'..bot_id.."groups",v) 
