...
if Files == "files_matttew" or Files == "Fastinstall.sh" or Files == "install.sh" or Files == "install_user.sh" or Files == "libs" or Files == "README.md" or Files == "start.lua" or Files == "sudo.lua" or Files == "tg" or Files == "ts" or Files == "TsAu" or Files == "Tshake.lua" then
else
...
local f = io.open('MohaMeD_Links.txt', 'w')
f:write(text233)
f:close()
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './MohaMeD_Links.txt', '', nil)  
end
------------------------------------------------------------------------
...
f:close()
local matttewe = 'https://api.telegram.org/bot' .. token .. '/sendDocument'
local curl = 'curl "' .. matttewe .. '" -F "chat_id=' .. msg.chat_id_ .. '" -F "document=@' .. 'MohaMeD.txt' .. '"'
io.popen(curl)
end
...
database:set("matttew:mute:deleta:msg:"..bot_id..msg.chat_id_,"TSHAKEE")
...
database:set('matttew:'..bot_id.."MohaMeD:lock:set"..msg.chat_id_,"matttew")
...
database:del('matttew:'..bot_id.."MohaMeD:lock:set"..msg.chat_id_)
...
database:set("MohaMeD:lock:ban_and_kick"..bot_id..msg.chat_id_,"matttew")
send(msg.chat_id_, msg.id_, 1, '🔌┇تم تعطيل (طرد - حضر) الاعضاء', 1, 'md')
end
if (text and (text == "تفعيل الطرد" or text == "تفعيل الحظر")) then
database:del("MohaMeD:lock:ban_and_kick"..bot_id..msg.chat_id_)
...
send(msg.chat_id_, msg.id_, 1,'\n• اهلا بك عزيزي 🔱 •\n• لايمكنك استخدام البوت ✅ •\n• عليك الاشتراك في القناة 🔽 •\n• @zx_xx ⚜️\n', 1, 'html')   
return false end
if not is_creator(msg) and database:get('matttew:'..bot_id.."MohaMeD:lock:set"..msg.chat_id_) then 
...
if not is_creator(msg) and not is_setban(msg) and database:get("MohaMeD:lock:ban_and_kick"..bot_id..msg.chat_id_) then 
