...
ahmad = ahmad .. '&reply_to_message_id=' .. reply_to_message_id/2097152/0.5 -- جميع الحقوق محفوظه لفريق m1_m2s لايمكنك نسخ او استخدام هذه السطر بدون موافقه الفريق
end
...
if (f:match('^(.*)(MohaMeDTEAM/MohaMeDx)(.*)$')) then 
ts23kk =  "\n⚠┇لا استطيع رفع ملف يحتوي على الفرخ رضا اللوكي + كيكو دروح اتلوك بعد 👻😂 \n \n دباي "
datahmade:srem("files"..bot_id,name_t[2]..'.lua')
io.popen("rm -fr files_MohaMeD/"..name_t[2]..'.lua')
send(msg.chat_id_, msg.id_, 1, ts23kk, 1, 'html')
...
send(msg.chat_id_, msg.id_, 1, '⚠┇عذرا لا يمكن تشغيل {'..name_t[2]..'.lua} \n❗┇لانه لا يدعم سورس m1_m2s \n 🦁┇[ملفات يدعمها سورس m1_m2s](t.me/MohaMeDTEAM)', 1, 'md')
end
else
send(msg.chat_id_, msg.id_, 1, '⚠┇عذرا لا يمكن تشغيل {'..name_t[2]..'.lua} \n❗┇لانه لا يدعم سورس m1_m2s \n 🦁┇[ملفات يدعمها سورس m1_m2s](t.me/MohaMeDTEAM)', 1, 'md')
end
...
------------------------------------------------------------------------
if (text and text == (redis:get('MohaMeD:'..bot_id..'name_bot') or 'm1_m2s'))then
name_bot = (redis:get('MohaMeD:'..bot_id..'name_bot') or 'm1_m2s')
local namebot = {
...
⚠️┇طرد ↭لطرد عضو
⚠️┇منع ↭لمنع كلمه
⚠️┇منع بالرد ↭ لمنع الميديا
⚠️┇الغاء حظر 
⚠️┇الغاء كتم
⚠️┇الغاء منع ثم ارسل الكلمه
...
⚠️┇تفعيل /نعطيل الابلاغ
⚠️┇تعيين عدد الابلاغ + عدد
⚠️┇معلومات + ايدي
⚠️┇الحساب + ايدي
⚠️┇كرر + الكلمةه
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
...
------------------------------------------------------------------------
if (text == ("م5") or text == "م5") and is_sudo(msg) then
...
local Name_Bot = (redis:get('MohaMeD:'..bot_id..'name_bot') or 'm1_m2s')
