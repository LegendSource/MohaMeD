...
os.execute('wget https://raw.githubusercontent.com/matttewabas/matttew/master/MohaMeD.lua')
dofile('MohaMeD.lua')  
return false
end
...
------------------------------------------------------------------------
if (text and text == (redis:get('matttew:'..bot_id..'name_bot') or 'ماثيو'))then
name_bot = (redis:get('matttew:'..bot_id..'name_bot') or 'ماثيو')
local namebot = {
...
local Name_Bot = (redis:get('matttew:'..bot_id..'name_bot') or 'ماثيو')
